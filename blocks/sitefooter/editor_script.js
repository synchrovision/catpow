	...
	wp.blocks.registerBlockType("catpow/sitefooter", {
		...
		edit(props) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ id: "SiteFooter", className: classes },
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "contents" },
						/* @__PURE__ */ wp.element.createElement(InnerBlocks, { template: [["core/paragraph", { content: CP.dummyText.text }]], templateLock: false })
					),
					/* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", className: "copyright", value: attributes.copyright, onChange: (copyright) => setAttributes({ copyright }) })
				),
				/* @__PURE__ */ wp.element.createElement(
					InspectorControls,
					null,
		...
		save({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement("div", { className: "copyright" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: attributes.copyright }))
			);
		},
	});
})();
