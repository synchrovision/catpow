...
registerBlockType('catpow/layouttable', {
	...
	edit: function edit(_ref) {
		...
		var saverows = function saverows() {
			setAttributes({ rows: rowsCopy.map(function (row) {
		...
		var selectCells = function selectCells(e, r, c) {
			if (e.metaKey) {
				...
				unselectAllCells();rowsCopy[r].cells[c].isSelected = true;
			}
			saverows();
		};
		...
		return [wp.element.createElement(
						...
						row.cells.map(function (cell, c) {
							...
							return el(cell.classes && cell.classes.split(' ').includes('th') ? 'th' : 'td', {
								...
								wp.element.createElement(RichText, { onChange: function onChange(text) {
										cell.text = text;saverows();
									}, value: cell.text }),
								isSelected && c == colLen - parseInt(cell.colspan ? cell.colspan : 1) && wp.element.createElement(
									'div',
								...
								isSelected && r == rowLen - parseInt(cell.rowspan ? cell.rowspan : 1) && wp.element.createElement(
									'div',
								...
								isSelected && cell.isSelected && wp.element.createElement('div', { className: 'selectBox' })
							));
						})
					);
				})
			...
			wp.element.createElement(
				...
				isRectSelection() && wp.element.createElement(
					Button,
				...
				selectedCells.some(function (cell) {
					return cell.rowspan > 1 || cell.colspan > 1;
				}) && wp.element.createElement(
					Button,
					{ isDefault: true, onClick: function onClick() {
