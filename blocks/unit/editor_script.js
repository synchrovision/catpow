(() => {
  ...
  wp.blocks.registerBlockType("catpow/unit", {
    ...
    edit({ attributes, className, setAttributes }) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement("div", { className: classes }, /* @__PURE__ */ wp.element.createElement("figure", { class: "image" }, /* @__PURE__ */ wp.element.createElement(
          ResponsiveImage,
          {
            attr: attributes,
            keys: imageKeys.image
          }
        )), /* @__PURE__ */ wp.element.createElement("div", { class: "contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, { template: [["core/paragraph", { content: CP.dummyText.text }]], templateLock: false }))),
