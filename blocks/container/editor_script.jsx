		...
		const selectiveClasses=useMemo(()=>{
			const selectiveClasses=[
				...
				{name:'scrollX',label:__('スクロールX','catpow'),values:'hasScrollX',sub:[
					{name:'contentWidth',label:__('コンテンツの幅','catpow'),vars:'boxSizeVars',key:'--cp-content-width',input:'range',min:400,max:2000,step:10}
				]},
				{name:'scrollY',label:__('スクロールY','catpow'),values:'hasScrollY',sub:[
					{name:'containerHeight',label:__('コンテナの高さ','catpow'),vars:'boxSizeVars',key:'--cp-container-height',input:'range',min:100,max:1000,step:10}
				]},
