    ...
    edit({ attributes, className, setAttributes, isSelected }) {
      ...
      const selectiveClasses = useMemo(() => {
        const selectiveClasses2 = [
          ...
          { name: "tableWidth", label: __("\u8868\u5E45", "catpow"), vars: "vars", key: "--cp-table-width", input: "range", min: 200, max: 3200, step: 10, cond: (states2) => !states2["has-fixed-column-width"] },
          "color",
          "isTemplate"
        ];
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(
      ...
      ), /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, AltMode && doLoop ? /* @__PURE__ */ wp.element.createElement("div", { className: "alt_content" }, /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(Icon, { icon: "welcome-comments" })), /* @__PURE__ */ wp.element.createElement(InnerBlocks, null)) : /* @__PURE__ */ wp.element.createElement("div", { ...blockProps }, states.hasTags && /* @__PURE__ */ wp.element.createElement("ul", { className: classes.tags() }, tagCells.map((cell, tagIndex) => {
        ...
        if (states.hasHeaderColumn && columnIndex == 0) {
          ...
          return /* @__PURE__ */ wp.element.createElement(
            ...
            !cellStates2.isSpacer && /* @__PURE__ */ wp.element.createElement("div", { "data-role": "contents" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (text2) => {
              cell.text = text2;
              saveItems();
            }, value: cell.text }))
          );
        ...
        return /* @__PURE__ */ wp.element.createElement(
          ...
          cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.thead.tr.th.label(), "data-role": "label" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (label) => {
            cell.label = label;
            saveItems();
          }, value: cell.label })),
          /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.thead.tr.th.contents(), "data-role": "contents" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (text2) => {
            cell.text = text2;
            saveItems();
          }, value: cell.text }))
        );
        ...
        return /* @__PURE__ */ wp.element.createElement("tr", { className: classes.table.tbody.tr(row.classes), "data-row-class": row.classes, key: rowIndex2 }, row.cells.map((cell, columnIndex) => {
          ...
          if (hasHeaderColumn && columnIndex == 0) {
            return /* @__PURE__ */ wp.element.createElement(
              "th",
              {
                ...
                "data-cell-class": cell.classes,
                onClick: () => setAttributes({ r: rowIndex2, c: columnIndex }),
                style: getCssVarsForCell(rowIndex2, columnIndex),
                key: columnIndex
              },
              cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.tbody.tr.th.label(), "data-role": "label" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (label) => {
                cell.label = label;
                saveItems();
              }, value: cell.label })),
              /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.tbody.tr.th.contents(), "data-role": "contents" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (text2) => {
                cell.text = text2;
                saveItems();
              }, value: cell.text })),
              controles
          ...
          return /* @__PURE__ */ wp.element.createElement(
            ...
            cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.tbody.tr.td.label(), "data-role": "label" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (label) => {
              cell.label = text;
              saveItems();
            }, value: cell.label })),
            ...
            )) : /* @__PURE__ */ wp.element.createElement("div", { className: classes.table.tbody.tr.td.contents(), "data-role": "contents" }, /* @__PURE__ */ wp.element.createElement(RichText, { onChange: (text2) => {
              cell.text = text2;
              saveItems();
            }, value: cell.text })),
            controles
