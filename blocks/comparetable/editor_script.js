    ...
    edit({ attributes, className, setAttributes, isSelected }) {
      ...
      const selectiveClasses = useMemo(() => {
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveClasses",
      ...
      const selectiveRowClasses = useMemo(() => {
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveRowClasses",
          CP.finderProxy(selectiveRowClasses2)
        );
        return selectiveRowClasses2;
      }, []);
      const selectiveHeaderRowClasses = useMemo(() => {
        const selectiveHeaderRowClasses2 = [
          "fontSize",
          "textAlign",
          "verticalAlign"
        ];
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveHeaderRowClasses",
          CP.finderProxy(selectiveHeaderRowClasses2)
        );
        return selectiveHeaderRowClasses2;
      }, []);
      const selectiveColClasses = useMemo(() => {
        const selectiveColClasses2 = [
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveColClasses",
          CP.finderProxy(selectiveColClasses2)
        );
        return selectiveColClasses2;
      }, []);
      const selectiveHeaderColClasses = useMemo(() => {
        const selectiveHeaderColClasses2 = [
          "fontSize",
          "textAlign",
          "verticalAlign"
        ];
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveHeaderColClasses",
          CP.finderProxy(selectiveHeaderColClasses2)
        );
      ...
      const selectiveCellClasses = useMemo(() => {
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveCellClasses",
          CP.finderProxy(selectiveCellClasses2)
        );
      ...
      const selectiveHeaderColCellClasses = useMemo(() => {
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveHeaderColCellClasses",
          CP.finderProxy(selectiveHeaderColCellClasses2)
        );
      ...
      const selectiveFirstCellClasses = useMemo(() => {
        ...
        wp.hooks.applyFilters(
          "catpow.blocks.comparetable.selectiveFirstCellClasses",
          CP.finderProxy(selectiveFirstCellClasses2)
        );
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(
        ...
        return /* @__PURE__ */ wp.element.createElement(
          "li",
          {
            className: classes.tags.tag(cell.classes),
            "data-wp-on--click": "actions.onClickTag",
            "data-wp-class--is-active": "callbacks.isTagActive",
            "data-index": tagIndex,
            key: tagIndex
          },
        ...
        /* @__PURE__ */ wp.element.createElement("colgroup", { className: classes.table.colgroup() }, cols.map((col, index2) => /* @__PURE__ */ wp.element.createElement(
          "col",
          {
            className: classes.table.colgroup.col(col.classes),
            "data-col-class": col.classes,
            key: index2
          }
        ))),
        hasHeaderRow && /* @__PURE__ */ wp.element.createElement("thead", { className: classes.table.thead() }, /* @__PURE__ */ wp.element.createElement(
          "tr",
          {
            className: classes.table.thead.tr(rows[0].classes),
            "data-row-class": rows[0].classes
          },
          rows[0].cells.map((cell, columnIndex) => {
            ...
            if (states.hasHeaderColumn && columnIndex == 0) {
              ...
              return /* @__PURE__ */ wp.element.createElement(
                "td",
                {
                  className: classes.table.thead.tr.td(
                    rows[0].classes,
                    headerColClasses,
                    firstCellClasses
                  ),
            ...
            const cellStates = CP.classNamesToFlags(
              cell.classes
            );
            return /* @__PURE__ */ wp.element.createElement(
              "th",
              {
                className: classes.table.thead.tr.th(
                  rows[0].classes,
                  cell.classes,
                  lineClass
                ),
              ...
              cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement(
                "div",
                {
                  className: classes.table.thead.tr.th.label(),
                  "data-role": "label"
                },
              ...
              /* @__PURE__ */ wp.element.createElement(
                "div",
                {
                  className: classes.table.thead.tr.th.contents(),
                  "data-role": "contents"
                },
                /* @__PURE__ */ wp.element.createElement(
                  RichText,
        ...
        /* @__PURE__ */ wp.element.createElement("tbody", { className: classes.table.tbody() }, rows.map((row, rowIndex2) => {
          ...
          return /* @__PURE__ */ wp.element.createElement(
            "tr",
            {
              className: classes.table.tbody.tr(row.classes),
              "data-row-class": row.classes,
              key: rowIndex2
            },
            row.cells.map((cell, columnIndex) => {
              const colStates = CP.classNamesToFlags(
                cols[columnIndex]?.classes
              );
              const cellStates = CP.classNamesToFlags(
                cell.classes
              );
              ...
              if (hasHeaderColumn && columnIndex == 0) {
                return /* @__PURE__ */ wp.element.createElement(
                  "th",
                  {
                    className: classes.table.tbody.tr.th(
                      row.classes,
                      headerColClasses,
                      cell.classes,
                      lineClass
                  ...
                  cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement(
                    "div",
                    {
                      className: classes.table.tbody.tr.th.label(),
                      "data-role": "label"
                    },
                    /* @__PURE__ */ wp.element.createElement(
                      RichText,
                  ...
                  /* @__PURE__ */ wp.element.createElement(
                    "div",
                    {
                      className: classes.table.tbody.tr.th.contents(),
                      "data-role": "contents"
                    },
                    /* @__PURE__ */ wp.element.createElement(
                      RichText,
              ...
              return /* @__PURE__ */ wp.element.createElement(
                "td",
                {
                  className: classes.table.tbody.tr.td(
                    row.classes,
                    cols[columnIndex]?.classes,
                    cell.classes,
                    lineClass
                ...
                cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement(
                  "div",
                  {
                    className: classes.table.tbody.tr.td.label(),
                    "data-role": "label"
                  },
                  /* @__PURE__ */ wp.element.createElement(
                    RichText,
                ...
                colStates.isImage ? /* @__PURE__ */ wp.element.createElement(
                  "div",
                  {
                    className: classes.table.tbody.tr.td.image(),
                    "data-role": "image"
                  },
                  /* @__PURE__ */ wp.element.createElement(
                  ...
                  "div",
                  {
                    className: classes.table.tbody.tr.td.contents(),
                    "data-role": "contents"
                  },
                  /* @__PURE__ */ wp.element.createElement(
                    RichText,
      ...
      ), r === 0 ? /* @__PURE__ */ wp.element.createElement(
        CP.SelectClassPanel,
        {
          title: "\u884C",
          icon: "art",
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement("div", { ...blockProps }, states.hasTags && /* @__PURE__ */ wp.element.createElement("ul", { className: classes.tags() }, tagCells.map((cell, tagIndex) => {
          ...
          rows[0].cells.map((cell, columnIndex) => {
            ...
            return /* @__PURE__ */ wp.element.createElement(
              ...
              cellStates.hasLabel && /* @__PURE__ */ wp.element.createElement(
                ...
                /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: cell.label })
              ),
              /* @__PURE__ */ wp.element.createElement(
                "div",
                {
        ...
        /* @__PURE__ */ wp.element.createElement("tbody", { className: classes.table.tbody() }, rows.map((row, rowIndex2) => {
          ...
          return /* @__PURE__ */ wp.element.createElement(
            "tr",
            {
              className: classes.table.tbody.tr(),
              "data-row-class": row.classes,
              key: rowIndex2
            },
            row.cells.map((cell, columnIndex) => {
