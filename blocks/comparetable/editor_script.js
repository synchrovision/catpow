	...
	wp.blocks.registerBlockType("catpow/comparetable", {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				wp.element.Fragment,
				null,
				/* @__PURE__ */ wp.element.createElement(CP.SelectModeToolbar, { set: setAttributes, attr: attributes, modes: ["AltMode"] }),
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									/* @__PURE__ */ wp.element.createElement(
										...
										/* @__PURE__ */ wp.element.createElement(
											...
											/* @__PURE__ */ wp.element.createElement(
												"colgroup",
												{ className: classes.table.colgroup() },
												cols.map((col, index) => /* @__PURE__ */ wp.element.createElement("col", { className: classes.table.colgroup.col(col.classes), "data-col-class": col.classes, key: index }))
											),
											hasHeaderRow &&
												/* @__PURE__ */ wp.element.createElement(
													"thead",
													{ className: classes.table.thead() },
													/* @__PURE__ */ wp.element.createElement(
														"tr",
														{ className: classes.table.thead.tr(rows[0].classes), "data-row-class": rows[0].classes },
														rows[0].cells.map((cell, columnIndex) => {
															...
															return /* @__PURE__ */ wp.element.createElement(
																...
																cellStates.hasLabel &&
																	/* @__PURE__ */ wp.element.createElement(
																		"div",
																		{ className: classes.table.thead.tr.th.label(), "data-role": "label" },
																		/* @__PURE__ */ wp.element.createElement(RichText, {
																			onChange: (label) => {
																				cell.label = label;
																				saveItems();
																...
																/* @__PURE__ */ wp.element.createElement(
																	"div",
																	{ className: classes.table.thead.tr.th.contents(), "data-role": "contents" },
																	/* @__PURE__ */ wp.element.createElement(RichText, {
																		onChange: (text2) => {
																			cell.text = text2;
																			saveItems();
											...
											/* @__PURE__ */ wp.element.createElement(
												...
												rows.map((row, rowIndex) => {
													...
													return /* @__PURE__ */ wp.element.createElement(
														"tr",
														{ className: classes.table.tbody.tr(row.classes), "data-row-class": row.classes, key: rowIndex },
														row.cells.map((cell, columnIndex) => {
															...
															if (isSelected && columnIndex == row.cells.length - 1) {
																controles.push(
																	/* @__PURE__ */ wp.element.createElement(CP.ItemControl, {
															...
															if (hasHeaderColumn && columnIndex == 0) {
																return /* @__PURE__ */ wp.element.createElement(
																	...
																	cellStates.hasLabel &&
																		/* @__PURE__ */ wp.element.createElement(
																			"div",
																			{ className: classes.table.tbody.tr.th.label(), "data-role": "label" },
																			/* @__PURE__ */ wp.element.createElement(RichText, {
																				onChange: (label) => {
																					cell.label = label;
																					saveItems();
																	...
																	/* @__PURE__ */ wp.element.createElement(
																		"div",
																		{ className: classes.table.tbody.tr.th.contents(), "data-role": "contents" },
																		/* @__PURE__ */ wp.element.createElement(RichText, {
																			onChange: (text2) => {
																				cell.text = text2;
																				saveItems();
															...
															return /* @__PURE__ */ wp.element.createElement(
																...
																cellStates.hasLabel &&
																	/* @__PURE__ */ wp.element.createElement(
																		"div",
																		{ className: classes.table.tbody.tr.td.label(), "data-role": "label" },
																		/* @__PURE__ */ wp.element.createElement(RichText, {
																			onChange: (label) => {
																				cell.label = text;
																				saveItems();
																...
																colStates.isImage
																	? /* @__PURE__ */ wp.element.createElement(
																			"div",
																			{ className: classes.table.tbody.tr.td.image(), "data-role": "image" },
																	...
																	: /* @__PURE__ */ wp.element.createElement(
																			"div",
																			{ className: classes.table.tbody.tr.td.contents(), "data-role": "contents" },
																			/* @__PURE__ */ wp.element.createElement(RichText, {
																				onChange: (text2) => {
																					cell.text = text2;
																					saveItems();
					...
					states.hasTags &&
						/* @__PURE__ */ wp.element.createElement(
							...
							tagCells.map((cell, tagIndex) => {
								...
								return /* @__PURE__ */ wp.element.createElement(
									"li",
									{ className: classes.tags.tag(cell.classes), "data-wp-on--click": "actions.onClickTag", "data-wp-class--is-active": "callbacks.isTagActive", "data-index": tagIndex, key: tagIndex },
									/* @__PURE__ */ wp.element.createElement(RichText.Content, { value: cell.text })
								);
							})
						),
							...
							/* @__PURE__ */ wp.element.createElement(
											...
											rows[0].cells.map((cell, columnIndex) => {
												...
												if (states.hasHeaderColumn && columnIndex == 0) {
													...
													return /* @__PURE__ */ wp.element.createElement(
														...
														!cellStates2.isSpacer &&
															/* @__PURE__ */ wp.element.createElement("div", { "data-role": "contents" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: cell.text }))
													);
												}
												const cellStates = CP.classNamesToFlags(cell.classes);
												return /* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									rows.map((row, rowIndex) => {
										...
										return /* @__PURE__ */ wp.element.createElement(
											"tr",
											{ className: classes.table.tbody.tr(), "data-row-class": row.classes, key: rowIndex },
											row.cells.map((cell, columnIndex) => {
												const colStates = CP.classNamesToFlags(cols[columnIndex]?.classes);
												const cellStates = CP.classNamesToFlags(cell.classes);
												const lineClass = ["is-even-line", "is-odd-line"][(states.doTransposition ? columnIndex : rowIndex) % 2];
												...
												return /* @__PURE__ */ wp.element.createElement(
													...
													colStates.isImage
														? /* @__PURE__ */ wp.element.createElement(
																"div",
																{ className: classes.table.tbody.tr.td.image(), "data-role": "image" },
																/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, {
																	className: classes.table.tbody.tr.td.image._img(),
																	attr: attributes,
																	keys: imageKeys.image,
																	index: [rowIndex, columnIndex],
