    ...
    from: [
      {
        ...
        transform: (files) => {
          var attributes = {
            classes:
              "wp-block-catpow-comparetable is-style-spec has-tags has-header-column do-transposition",
            rows: [
  ...
  edit({ attributes, className, setAttributes, isSelected }) {
    ...
    const selectiveRowClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveRowClasses)
      );
    ...
    const selectiveHeaderRowClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveHeaderRowClasses)
      );
    ...
    const selectiveColClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveColClasses)
      );
    ...
    const selectiveHeaderColClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveHeaderColClasses)
      );
    ...
    const selectiveCellClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveCellClasses)
      );
    ...
    const selectiveHeaderColCellClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveHeaderColCellClasses)
      );
    ...
    const selectiveFirstCellClasses = useMemo(() => {
      ...
      wp.hooks.applyFilters(
        ...
        CP.finderProxy(selectiveFirstCellClasses)
      );
    ...
    const tagCells = states.doTransposition
                      ...
                      <thead className={classes.table.thead()}>
                        ...
                        >
                          {rows[0].cells.map((cell, columnIndex) => {
                            const lineClass = ["is-even-line", "is-odd-line"][
                              (states.doTransposition ? columnIndex : 0) % 2
                            ];
                            if (states.hasHeaderColumn && columnIndex == 0) {
                              const cellStates =
                                CP.classNamesToFlags(firstCellClasses);
                              return (
                                <td
                                  ...
                                  onClick={() =>
                                    setAttributes({ r: 0, c: columnIndex })
                                  }
        ...
        <InspectorControls>
          ...
          {states.hasHeaderColumn && r === 0 && c === 0 ? (
            ...
            <CP.SelectClassPanel
              ...
              attr={attributes}
              selectiveClasses={
                c === 0 ? selectiveHeaderColCellClasses : selectiveCellClasses
              }
              items={rows}
              itemsKey="rows"
              index={r}
                ...
                {hasHeaderRow && (
                  <thead className={classes.table.thead()}>
                    ...
                    >
                      {rows[0].cells.map((cell, columnIndex) => {
                        const lineClass = ["is-even-line", "is-odd-line"][
                          states.doTransposition ? columnIndex % 2 : 0
                        ];
                        if (states.hasHeaderColumn && columnIndex == 0) {
                          const cellStates =
                            CP.classNamesToFlags(firstCellClasses);
                    ...
                    return (
                      ...
                      >
                        {row.cells.map((cell, columnIndex) => {
                          ...
                          const cellStates = CP.classNamesToFlags(cell.classes);
                          const lineClass = ["is-even-line", "is-odd-line"][
                            (states.doTransposition ? columnIndex : rowIndex) %
                              2
                          ];
                          if (hasHeaderColumn && columnIndex == 0) {
                            return (
