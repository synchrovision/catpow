...
$attributes=[
	...
	"headerColClasses"=>["source"=>"attribute","attribute"=>"data-header-col-class","selector"=>".{$block_class}","default"=>"has-text-align-center has-vertical-align-middle"],
	"firstCellClasses"=>["source"=>"attribute","attribute"=>"data-first-cell-class","selector"=>".{$block_class}","default"=>"is-spacer"],
	"cols"=>[
		"source"=>"query",
		"selector"=>"table col",
		"query"=>[
