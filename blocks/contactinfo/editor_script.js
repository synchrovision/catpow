  ...
  wp.blocks.registerBlockType("catpow/contactinfo", {
    ...
    edit({ attributes, className, setAttributes, isSelected }) {
      ...
      [...Array(len).keys()].forEach((i) => {
        ...
        rtn.push(
          /* @__PURE__ */ wp.element.createElement(
            ...
            states.hasItemTitle && /* @__PURE__ */ wp.element.createElement(
              RichText,
              {
                tagName: "h4",
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(
        ...
        CP.SelectClassPanel,
        {
          ...
          attr: attributes,
          selectiveClasses,
          filters: CP.filters.contactinfo || {}
        }
    ...
    save({ attributes, className }) {
      ...
      items.forEach((item, index) => {
        const itemClasses = classes._items.item;
        rtn.push(
          /* @__PURE__ */ wp.element.createElement("li", { className: itemClasses(), key: index }, states.hasItemTitle && /* @__PURE__ */ wp.element.createElement(
            RichText.Content,
            {
              tagName: "h4",
              className: itemClasses.title(),
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement("div", { ...useBlockProps.save({ className: classes() }) }, states.hasTitle && /* @__PURE__ */ wp.element.createElement(
        RichText.Content,
        {
          tagName: "h3",
          className: classes._title(),
      ...
      ), /* @__PURE__ */ wp.element.createElement("ul", { className: classes._items() }, rtn), states.hasLead && /* @__PURE__ */ wp.element.createElement(
        RichText.Content,
        {
          tagName: "small",
          className: classes._caption(),
