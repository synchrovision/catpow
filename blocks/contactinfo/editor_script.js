			...
			[...Array(len).keys()].forEach((i) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							CP.Link.Edit,
							{ className: itemClasses.link(), attr: attributes, set: setAttributes, keys: linkKeys.link, index },
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(TextareaControl, { label: "\u30AF\u30E9\u30B9", onChange: (classes2) => setAttributes({ classes: classes2 }), value: attributes.classes })
					),
					...
					: /* @__PURE__ */ wp.element.createElement(
							...
							AltMode && doLoop
								...
								: /* @__PURE__ */ wp.element.createElement(
										...
										/* @__PURE__ */ wp.element.createElement("ul", { className: classes._items() }, rtn),
										states.hasCaption &&
											/* @__PURE__ */ wp.element.createElement(RichText, {
												tagName: "small",
			...
			items.forEach((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						...
						states.hasItemTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h4", className: itemClasses.title(), value: item.title }),
						states.hasItemLead && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "p", className: itemClasses.lead(), value: item.lead }),
						/* @__PURE__ */ wp.element.createElement(
							CP.Link,
							{ className: itemClasses.link(), attr: attributes, keys: linkKeys.link, index, ...CP.extractEventDispatcherAttributes("catpow/contactinfo", item) },
							states.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { className: itemClasses.link.icon(), item: attributes }),
							/* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "span", className: itemClasses.link.text(), value: item.link })
						),
						states.hasItemCaption && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "small", className: itemClasses.caption(), value: item.caption })
					)
				);
			});
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					states.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h3", className: classes._title(), value: title }),
					states.hasLead && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "p", className: classes._lead(), value: lead }),
					/* @__PURE__ */ wp.element.createElement("ul", { className: classes._items() }, rtn),
					states.hasLead && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "small", className: classes._caption(), value: caption })
				),
