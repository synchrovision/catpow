					...
					states.collapsible &&
						/* @__PURE__ */ wp.element.createElement(
							...
							/* @__PURE__ */ wp.element.createElement(
								...
								states.imageButton && [
									/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "open", attr: attributes, keys: imageKeys.openButtonImage }),
									/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "close", attr: attributes, keys: imageKeys.closeButtonImage }),
								]
							)
						),
					/* @__PURE__ */ wp.element.createElement(
						...
						(states.container || states.collapsible) && /* @__PURE__ */ wp.element.createElement(InnerBlocks2, null)
					)
				),
				/* @__PURE__ */ wp.element.createElement(
					InspectorControls,
		...
		save({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				states.collapsible &&
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "stickyButtonIcon" },
							states.labelButton && /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: labelText })),
							states.imageButton && [
								/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "open", attr: attributes, keys: imageKeys.openButtonImage }),
								/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "close", attr: attributes, keys: imageKeys.closeButtonImage }),
							]
				...
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ className: "content" },
					states.label && /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: labelText })),
					(states.container || states.collapsible) && /* @__PURE__ */ wp.element.createElement(InnerBlocks2.Content, null)
				)
			);
		},
		deplicated: [
				...
				save({ attributes, className, setAttributes }) {
					...
					return /* @__PURE__ */ wp.element.createElement(
						...
						states.collapsible &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "stickyMenuButton" },
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "stickyMenuButtonIcon" },
									states.labelButton && /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: labelText })),
									states.imageButton && [
										/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "open", attr: attributes, keys: imageKeys.openButtonImage }),
										/* @__PURE__ */ wp.element.createElement(ResponsiveImage, { className: "close", attr: attributes, keys: imageKeys.closeButtonImage }),
									]
						...
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "content" },
							states.label && /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: labelText })),
							(states.container || states.collapsible) && /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null)
						)
					);
				},
			},
		...
		edit({ attributes, className, setAttributes }) {
			return [
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(InnerBlocks, { template: [["core/paragraph"]], templateLock: false })
				),
			];
		},
		save({ attributes, className, setAttributes }) {
