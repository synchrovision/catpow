	...
	wp.blocks.registerBlockType("catpow/banners", {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			const selectiveClasses = useMemo(() => {
				var selectiveClasses2 = ["itemSize", "itemGap", "contentWidth", "customMargin", "customPadding", { label: "\u30BF\u30A4\u30C8\u30EB", values: "hasTitle" }, "isTemplate"];
			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ className: "_item", tag: "li", set: setAttributes, attr: attributes, items, index, isSelected, key: index },
						states.hasTitle &&
						...
						/* @__PURE__ */ wp.element.createElement(
							CP.Link.Edit,
							{ className: "_link", attr: attributes, set: setAttributes, keys: linkKeys.link, index, isSelected },
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(CP.SelectDeviceToolbar, { attr: attributes, set: setAttributes, devices }),
				/* @__PURE__ */ wp.element.createElement(
					InspectorControls,
					null,
				...
				EditMode
					...
					: /* @__PURE__ */ wp.element.createElement(
							...
							AltMode && doLoop
								...
								: /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement("ul", { ...blockProps }, rtn))
					  )
			);
		},
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						items.map((item, index) => {
							return /* @__PURE__ */ wp.element.createElement(
								...
								states.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: "h3", className: "_title", value: item.title }),
								/* @__PURE__ */ wp.element.createElement(
									CP.Link,
									{ className: "_link", attr: attributes, keys: linkKeys.link, index, ...CP.extractEventDispatcherAttributes("catpow/banners", item) },
