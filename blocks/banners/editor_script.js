			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				EditMode
					? /* @__PURE__ */ wp.element.createElement(
							"div",
							{ ...blockProps },
							/* @__PURE__ */ wp.element.createElement(CP.Label, { icon: "edit" }),
					...
					: /* @__PURE__ */ wp.element.createElement(
							...
							AltMode && doLoop
								? /* @__PURE__ */ wp.element.createElement(
										"div",
										{ ...blockProps },
										/* @__PURE__ */ wp.element.createElement(CP.Label, { icon: "welcome-comments" }),
										...
										/* @__PURE__ */ wp.element.createElement(
											...
											[...Array(Math.max(items.length, loopCount)).keys()].map((i) => {
												...
												return /* @__PURE__ */ wp.element.createElement(
													...
													/* @__PURE__ */ wp.element.createElement(
														CP.Link.Edit,
														{ className: "_link", attr: attributes, set: setAttributes, keys: linkKeys.link, index },
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						items.map((item, index) => {
							return /* @__PURE__ */ wp.element.createElement(
								...
								states.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: HeadingTag, className: "_title", value: item.title }),
								/* @__PURE__ */ wp.element.createElement(
									CP.Link,
