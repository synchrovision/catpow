...
registerBlockType('catpow/section', {
  ...
  attributes: {
    ...
    id: {
      source: 'attribute',
      selector: '.wp-block-catpow-section',
      attribute: 'id'
    },
    classes: {
      source: 'attribute',
      selector: '.wp-block-catpow-section',
      attribute: 'class',
      default: 'wp-block-catpow-section article level3 center catch'
    },
    navIcon: {
      source: 'attribute',
      selector: '.wp-block-catpow-section',
    ...
    prefix: {
      source: 'children',
      selector: 'header div.prefix'
    },
    title: {
      type: 'array',
      source: 'children',
      selector: 'header h2,header .heading',
      default: ['Title']
    },
    lead: {
      type: 'array',
    ...
    headerBackgroundImageMime: {
      source: 'attribute',
      selector: 'header .background [src]',
      attribute: 'data-mime'
    },
    headerBackgroundImageSrc: {
      source: 'attribute',
      selector: 'header .background [src]',
      attribute: 'src',
      default: cp.theme_url + '/images/dummy_bg.jpg'
    },
    headerBackgroundImageSrcset: {
      source: 'attribute',
      selector: 'header .background [src]',
      attribute: 'srcset'
    },
    headerBackgroundImageAlt: {
      source: 'attribute',
      selector: 'header .background [src]',
      attribute: 'alt'
    },
    ...
    backgroundImageSrc: {
      source: 'attribute',
      selector: '.wp-block-catpow-section>.background [src]',
      attribute: 'src',
      default: cp.theme_url + '/images/dummy_bg.jpg'
    },
    ...
    backgroundImageCode: {
      source: 'text',
      selector: '.wp-block-catpow-section>.background'
    },
    ...
    patternImageCss: {
      source: 'text',
      selector: 'style.patternImageCss'
    },
    headerPatternImageCss: {
      source: 'text',
      selector: 'style.headerPatternImageCss'
    },
    frameImageCss: {
      source: 'text',
      selector: 'style.frameImageCss'
    },
    borderImageCss: {
      source: 'text',
      selector: 'style.borderImageCss'
    },
    iconSrc: {
      source: 'attribute',
      selector: '.icon [src]',
  ...
  edit: function edit(props) {
    ...
    return [wp.element.createElement(BlockControls, null, wp.element.createElement(CP.AlignClassToolbar, {
      ...
      class: "title"
    }, states.hasIcon && wp.element.createElement("div", {
      class: "icon"
  ...
  deprecated: [{
    ...
    save: function save(_ref2) {
      ...
      return wp.element.createElement("section", {
        ...
        attr: attributes,
        keys: imageKeys.headerImage
      })), wp.element.createElement("h2", null, title), states.hasRead && wp.element.createElement("p", null, wp.element.createElement(RichText.Content, {
        value: read
      }))), states.hasHeaderBackgroundImage && wp.element.createElement("div", {
        class: "background"
      }, states.isTemplate && headerBackgroundImageCode ? headerBackgroundImageCode : wp.element.createElement(CP.ResponsiveImage, {
