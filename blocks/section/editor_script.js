(() => {
	...
	wp.blocks.registerBlockType("catpow/section", {
		...
		edit(props) {
						...
						sub: {
							scene: [
								...
								{ name: "prefix", label: __("\u30D7\u30EC\u30D5\u30A3\u30AF\u30B9", "catpow"), values: "hasPrefix" },
								{
									...
									sub: [{ input: "picture", keys: imageKeys2.titleImage, devices: devices2 }],
								},
								{
									name: "headerImage",
									label: __("\u30D8\u30C3\u30C0\u753B\u50CF", "catpow"),
									values: "hasHeaderImage",
									sub: [{ input: "image", keys: imageKeys2.headerImage, size: imageSizes2.headerImage }],
								},
								{
							...
							article: [
								...
								},
								{
									...
									sub: [{ input: "frame", css: "frameImageCss", sel: ({ attr }) => `#${attr.anchor}`, color }],
								},
								{
									name: "borderImage",
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					SectionTag,
					{ id: anchor, className: classes, ref: setMainBlock, style: vars },
					states.hasImage &&
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "image" },
							states.isTemplate && imageCode
								? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: imageCode })
								: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", attr: attributes, set: setAttributes, keys: imageKeys.image, size: imageSizes.image })
						),
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "contents" },
						...
						/* @__PURE__ */ wp.element.createElement(
							...
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "title" },
								states.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item: attributes }),
								states.hasPrefix &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "prefix" },
										/* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", value: prefix, onChange: (prefix2) => setAttributes({ prefix: prefix2 }) })
									),
								states.hasHeaderImage &&
									/* @__PURE__ */ wp.element.createElement(
										...
										states.isTemplate && headerImageCode
											? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: headerImageCode })
								...
								states.hasTitleImage
									? /* @__PURE__ */ wp.element.createElement(
											...
											states.isTemplate && titleImageCode
												? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: titleImageCode })
												: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.titleImage, devices })
									  )
									: /* @__PURE__ */ wp.element.createElement(RichText, { tagName: HeadingTag, className: "heading", value: title, onChange: (title2) => setAttributes({ title: title2 }) }),
								states.hasLead && /* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", className: "lead", value: lead, onChange: (lead2) => setAttributes({ lead: lead2 }) })
							),
							states.hasHeaderBackgroundImage &&
								/* @__PURE__ */ wp.element.createElement(
									...
									states.isTemplate && headerBackgroundImageCode
										? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: headerBackgroundImageCode })
										: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.headerBackgroundImage })
								)
						),
						/* @__PURE__ */ wp.element.createElement("div", { className: "text" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))
					),
					states.hasBackgroundImage &&
						/* @__PURE__ */ wp.element.createElement(
							...
							states.isTemplate && backgroundImageCode
								? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: backgroundImageCode })
								: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.backgroundImage })
						),
					states.hasPatternImage && /* @__PURE__ */ wp.element.createElement("style", null, patternImageCss),
					states.hasHeaderPatternImage && /* @__PURE__ */ wp.element.createElement("style", null, headerPatternImageCss),
					states.hasBorderImage && /* @__PURE__ */ wp.element.createElement("style", null, borderImageCss),
					states.hasFrameImage && /* @__PURE__ */ wp.element.createElement("style", null, frameImageCss)
				),
				/* @__PURE__ */ wp.element.createElement(
					InspectorControls,
					null,
					/* @__PURE__ */ wp.element.createElement(
						CP.ColorVarTracer,
						{ target: mainBlock },
						/* @__PURE__ */ wp.element.createElement(CP.SelectClassPanel, { title: __("\u30AF\u30E9\u30B9", "catpow"), icon: "art", set: setAttributes, attr: attributes, selectiveClasses }),
						/* @__PURE__ */ wp.element.createElement(
							PanelBody,
							{ title: "ID", icon: "admin-links", initialOpen: false },
							/* @__PURE__ */ wp.element.createElement(TextControl, {
								label: "ID",
								onChange: (anchor2) => {
						...
						/* @__PURE__ */ wp.element.createElement(
							...
							/* @__PURE__ */ wp.element.createElement(TextareaControl, { label: __("\u30AF\u30E9\u30B9", "catpow"), onChange: (classes2) => setAttributes({ classes: classes2 }), value: classes })
						)
					)
				)
			);
		...
		save({ attributes, className }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				SectionTag,
				{ id: anchor, className: classes, "data-icon": navIcon, style: vars },
				states.hasImage &&
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "image" },
						states.isTemplate && imageCode
							? imageCode
							: /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.image, size: "medium_large" })
					),
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ className: "contents" },
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							...
							{ className: "title" },
							states.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item: attributes }),
							states.hasPrefix && /* @__PURE__ */ wp.element.createElement("div", { className: "prefix" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: prefix })),
							states.hasHeaderImage &&
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "image" },
									states.isTemplate && headerImageCode
										? headerImageCode
										: /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.headerImage })
								),
							states.hasTitleImage
								? /* @__PURE__ */ wp.element.createElement(
										HeadingTag,
										...
										states.isTemplate && titleImageCode
											? titleImageCode
											: /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.titleImage, devices })
								  )
								: /* @__PURE__ */ wp.element.createElement(HeadingTag, { className: "heading" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: title })),
							states.hasLead && /* @__PURE__ */ wp.element.createElement("div", { className: "lead" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: lead }))
						),
						states.hasHeaderBackgroundImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								...
								states.isTemplate && headerBackgroundImageCode
									? headerBackgroundImageCode
									: /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.headerBackgroundImage, devices })
							)
					),
					/* @__PURE__ */ wp.element.createElement("div", { className: "text" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null))
				),
				states.hasBackgroundImage &&
					/* @__PURE__ */ wp.element.createElement(
						"div",
						...
						states.isTemplate && backgroundImageCode
							? backgroundImageCode
							: /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.backgroundImage, devices })
					),
				states.hasPatternImage && /* @__PURE__ */ wp.element.createElement("style", { className: "patternImageCss" }, patternImageCss),
				states.hasHeaderPatternImage && /* @__PURE__ */ wp.element.createElement("style", { className: "headerPatternImageCss" }, headerPatternImageCss),
				states.hasBorderImage && /* @__PURE__ */ wp.element.createElement("style", { className: "borderImageCss" }, borderImageCss),
				states.hasFrameImage && /* @__PURE__ */ wp.element.createElement("style", { className: "frameImageCss" }, frameImageCss)
			);
		},
	});
})();
