(() => {
  ...
  wp.blocks.registerBlockType("catpow/section", {
    ...
    edit(props) {
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(BlockControls, null, /* @__PURE__ */ wp.element.createElement(CP.AlignClassToolbar, { set: setAttributes, attr: attributes })), /* @__PURE__ */ wp.element.createElement(SectionTag, { id: anchor, className: classes, ref: setMainBlock, style: vars }, states.hasImage && /* @__PURE__ */ wp.element.createElement("div", { className: "image" }, states.isTemplate && imageCode ? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: imageCode }) : /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", attr: attributes, set: setAttributes, keys: imageKeys.image, size: imageSizes.image })), /* @__PURE__ */ wp.element.createElement("div", { className: clsx("contents", { "has-content-width": !states.hasWideContents }) }, states.hasDecoration && /* @__PURE__ */ wp.element.createElement(CP.PlacedPictures.Edit, { className: "decoration", set: setAttributes, attr: attributes, devices, keys: imageKeys.decoration }), /* @__PURE__ */ wp.element.createElement("header", { className: "header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "title" }, states.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item: attributes }), states.hasPrefix && /* @__PURE__ */ wp.element.createElement("div", { className: "prefix" }, /* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", value: prefix, onChange: (prefix2) => setAttributes({ prefix: prefix2 }) })), states.hasHeaderImage && /* @__PURE__ */ wp.element.createElement("div", { className: "image" }, states.isTemplate && headerImageCode ? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: headerImageCode }) : /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.headerImage, size: imageSizes.headerImage })), states.hasTitleImage ? /* @__PURE__ */ wp.element.createElement(HeadingTag, { className: "titleImage" }, states.isTemplate && titleImageCode ? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: titleImageCode }) : /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.titleImage, devices })) : /* @__PURE__ */ wp.element.createElement(RichText, { tagName: HeadingTag, className: "heading", value: title, onChange: (title2) => setAttributes({ title: title2 }) }), states.hasLead && /* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", className: "lead", value: lead, onChange: (lead2) => setAttributes({ lead: lead2 }) })), states.hasHeaderBackgroundImage && /* @__PURE__ */ wp.element.createElement("div", { className: "background" }, states.isTemplate && headerBackgroundImageCode ? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: headerBackgroundImageCode }) : /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.headerBackgroundImage }))), /* @__PURE__ */ wp.element.createElement("div", { className: "text" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))), states.hasBackgroundImage && /* @__PURE__ */ wp.element.createElement("div", { className: "background" }, states.isTemplate && backgroundImageCode ? /* @__PURE__ */ wp.element.createElement(CP.DummyImage, { text: backgroundImageCode }) : /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "image", set: setAttributes, attr: attributes, keys: imageKeys.backgroundImage })), states.hasPatternImage && /* @__PURE__ */ wp.element.createElement("style", null, patternImageCss), states.hasHeaderPatternImage && /* @__PURE__ */ wp.element.createElement("style", null, headerPatternImageCss), states.hasBorderImage && /* @__PURE__ */ wp.element.createElement("style", null, borderImageCss), states.hasFrameImage && /* @__PURE__ */ wp.element.createElement("style", null, frameImageCss)), /* @__PURE__ */ wp.element.createElement(InspectorControls, null, /* @__PURE__ */ wp.element.createElement(CP.ColorVarTracer, { target: mainBlock }, /* @__PURE__ */ wp.element.createElement(CP.SelectClassPanel, { title: __("\u30AF\u30E9\u30B9", "catpow"), icon: "art", set: setAttributes, attr: attributes, selectiveClasses }), /* @__PURE__ */ wp.element.createElement(PanelBody, { title: "ID", icon: "admin-links", initialOpen: false }, /* @__PURE__ */ wp.element.createElement(
        TextControl,
        {
          label: "ID",
          onChange: (anchor2) => {
    ...
    save({ attributes, className }) {
      ...
      const states = CP.classNamesToFlags(classes);
      const { devices, imageKeys, imageSizes } = CP.config.section;
      return /* @__PURE__ */ wp.element.createElement(SectionTag, { id: anchor, className: classes, "data-icon": navIcon, style: vars }, states.hasImage && /* @__PURE__ */ wp.element.createElement("div", { className: "image" }, states.isTemplate && imageCode ? imageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.image, size: "medium_large" })), /* @__PURE__ */ wp.element.createElement("div", { className: clsx("contents", { "has-content-width": !states.hasWideContents }) }, states.hasDecoration && /* @__PURE__ */ wp.element.createElement(CP.PlacedPictures, { className: "decoration", attr: attributes, keys: imageKeys.decoration }), /* @__PURE__ */ wp.element.createElement("header", { className: "header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "title" }, states.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item: attributes }), states.hasPrefix && /* @__PURE__ */ wp.element.createElement("div", { className: "prefix" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: prefix })), states.hasHeaderImage && /* @__PURE__ */ wp.element.createElement("div", { className: "image" }, states.isTemplate && headerImageCode ? headerImageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.headerImage })), states.hasTitleImage ? /* @__PURE__ */ wp.element.createElement(HeadingTag, { className: "titleImage" }, states.isTemplate && titleImageCode ? titleImageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.titleImage, devices })) : /* @__PURE__ */ wp.element.createElement(HeadingTag, { className: "heading" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: title })), states.hasLead && /* @__PURE__ */ wp.element.createElement("div", { className: "lead" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: lead }))), states.hasHeaderBackgroundImage && /* @__PURE__ */ wp.element.createElement("div", { className: "background" }, states.isTemplate && headerBackgroundImageCode ? headerBackgroundImageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.headerBackgroundImage, devices }))), /* @__PURE__ */ wp.element.createElement("div", { className: "text" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null))), states.hasBackgroundImage && /* @__PURE__ */ wp.element.createElement("div", { className: "background" }, states.isTemplate && backgroundImageCode ? backgroundImageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "image", attr: attributes, keys: imageKeys.backgroundImage, devices })), states.hasPatternImage && /* @__PURE__ */ wp.element.createElement("style", { className: "patternImageCss" }, patternImageCss), states.hasHeaderPatternImage && /* @__PURE__ */ wp.element.createElement("style", { className: "headerPatternImageCss" }, headerPatternImageCss), states.hasBorderImage && /* @__PURE__ */ wp.element.createElement("style", { className: "borderImageCss" }, borderImageCss), states.hasFrameImage && /* @__PURE__ */ wp.element.createElement("style", { className: "frameImageCss" }, frameImageCss));
    }
  });
})();
