			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "button", "data-action": item.action, "data-callback": item.callback, "data-target": item.target, "ignore-message": item.ignoreMessage, ...eventDispatcherAttributes },
							itemStates.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item }),
							item.text
						)
					)
		...
		deprecated: [
			{
				...
				save({ attributes, className }) {
					...
					let rtn = [];
					items.map((item, index) => {
						rtn.push(/* @__PURE__ */ wp.element.createElement("li", { className: item.classes, "data-event": item.event }, item.button));
					});
					return /* @__PURE__ */ wp.element.createElement("ul", { className: classes }, rtn);
				},
				migrate(attributes) {
