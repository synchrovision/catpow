			...
			const pushItem = (item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ tag: "li", className: itemClass, set: setAttributes, attr: attributes, items, index, style: { "--item-p": p }, key: index },
						states.hasSlide &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "slide" },
						...
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "image" },
								/* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { attr: attributes, set: setAttributes, keys: imageKeys.image, index, isTemplate: states.isTemplate })
							),
						(states.hasTitle || states.hasSubTitle || states.hasText) &&
							/* @__PURE__ */ wp.element.createElement(
								...
								{ className: "texts" },
								states.hasTitle &&
									/* @__PURE__ */ wp.element.createElement(RichText, {
										tagName: "h3",
										className: "title",
										onChange: (title) => {
											item.title = title;
						...
						states.hasLink && /* @__PURE__ */ wp.element.createElement(CP.Link.Edit, { className: "link", attr: attributes, set: setAttributes, keys: linkKeys.link, index, isSelected })
					)
				);
				if (states.hasImage && states.hasThumbnail) {
					thumbs.push(
						/* @__PURE__ */ wp.element.createElement(
							"li",
							{ className: "item " + posClass + " thumb" + p, onClick: () => gotoItem(index), key: index },
							/* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { attr: attributes, set: setAttributes, keys: imageKeys.image, index, isTemplate: states.isTemplate })
						)
					);
				}
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(TextareaControl, { label: "\u30AF\u30E9\u30B9", onChange: (classes3) => setAttributes({ classes: classes3 }), value: classes2 }),
						/* @__PURE__ */ wp.element.createElement(TextareaControl, {
							label: "\u30B3\u30F3\u30C8\u30ED\u30FC\u30E9\u30FC\u30AF\u30E9\u30B9",
				...
				attributes.EditMode
					...
					: /* @__PURE__ */ wp.element.createElement(
							...
							AltMode && doLoop
								...
								: /* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: classes2, style: vars },
										/* @__PURE__ */ wp.element.createElement("ul", { className: "contents" }, rtn),
										/* @__PURE__ */ wp.element.createElement(
											"div",
											{ className: controlClasses, "data-config": config },
											states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow prev", onClick: prevItem }, " "),
											states.hasImage && states.hasThumbnail && /* @__PURE__ */ wp.element.createElement("ul", { className: "thumbnail" }, thumbs),
											states.hasDots && /* @__PURE__ */ wp.element.createElement("ul", { className: "dots" }, dots),
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						states.hasSlide &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "slide" },
								/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.slide, devices, index, isTemplate: states.isTemplate })
							),
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "image" },
								/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.image, index, isTemplate: states.isTemplate })
							),
						(states.hasTitle || states.hasSubTitle || states.hasText) &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "texts" },
								states.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h3", className: "title", value: item.title }),
								states.hasSubTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h4", className: "subtitle", value: item.subTitle }),
								states.hasText && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "p", className: "text", value: item.text })
							),
						states.hasBackgroundImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "background" },
								/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.backgroundImage, devices, index, isTemplate: states.isTemplate })
							),
						states.hasLink && /* @__PURE__ */ wp.element.createElement(CP.Link, { className: "link", attr: attributes, keys: linkKeys.link, index })
					)
				);
				if (states.hasImage && states.hasThumbnail) {
					thumbs.push(
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: controlClasses, "data-config": config },
						states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow prev" }, " "),
						states.hasImage && states.hasThumbnail && /* @__PURE__ */ wp.element.createElement("ul", { className: "thumbnail" }, thumbs),
						states.hasDots && /* @__PURE__ */ wp.element.createElement("ul", { className: "dots" }, /* @__PURE__ */ wp.element.createElement("li", { className: "dot" }, " ")),
						states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow next" }, " ")
					)
				),
				...
				save({ attributes, className }) {
					...
					items.map(function (item, index) {
						...
						rtn.push(
							/* @__PURE__ */ wp.element.createElement(
								"li",
								{ className: "item", style: item.bg, key: index },
								states.hasImage && /* @__PURE__ */ wp.element.createElement("div", { className: "image" }, /* @__PURE__ */ wp.element.createElement("img", { src: item.src, alt: item.alt })),
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "text" },
									states.hasTitle && /* @__PURE__ */ wp.element.createElement("h3", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.title })),
									states.hasSubTitle && /* @__PURE__ */ wp.element.createElement("h4", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.subTitle })),
									states.hasText && /* @__PURE__ */ wp.element.createElement("p", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.text }))
								)
							)
						);
						if (states.hasThumbnail) {
							thumbs.push(/* @__PURE__ */ wp.element.createElement("li", { className: "item", style: item.bg }, /* @__PURE__ */ wp.element.createElement("img", { src: item.src, alt: item.alt })));
						}
					});
					return /* @__PURE__ */ wp.element.createElement(
						"div",
						...
						/* @__PURE__ */ wp.element.createElement(
							...
							{ className: controlClasses, "data-config": config },
							states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow prev" }, " "),
							states.hasThumbnail && /* @__PURE__ */ wp.element.createElement("ul", { className: "thumbnail" }, thumbs),
							states.hasDots && /* @__PURE__ */ wp.element.createElement("ul", { className: "dots" }, /* @__PURE__ */ wp.element.createElement("li", { className: "dot" }, " ")),
							states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow next" }, " ")
						)
					);
			...
			},
			{
				save({ attributes, className }) {
							...
							/* @__PURE__ */ wp.element.createElement(
								...
								states.hasSlide &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "slide" },
										/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.slide, index, isTemplate: states.isTemplate })
									),
								states.hasImage &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
								...
								states.hasBackgroundImage &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "background" },
										/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.backgroundImage, index, isTemplate: states.isTemplate })
									),
					...
					return /* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: classes2 },
						/* @__PURE__ */ wp.element.createElement("ul", { className: "contents" }, states.doLoop && "[loop_template " + (loopParam || "") + "]", rtn, states.doLoop && "[/loop_template]"),
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: controlClasses, "data-config": config },
							states.hasArrows && /* @__PURE__ */ wp.element.createElement("div", { className: "arrow prev" }, " "),
