	...
	wp.blocks.registerBlockType("catpow/graphics", {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			const selectiveClasses = useMemo(() => {
				const { devices: devices2, imageKeys: imageKeys2 } = CP.config.graphics;
			...
			const InputHeights = useCallback((props) => {
				...
				return /* @__PURE__ */ wp.element.createElement(
					BaseControl,
					{ label: __("\u9AD8\u3055", "catpow") },
					devices2.map((device2, index) =>
						/* @__PURE__ */ wp.element.createElement(RangeControl, {
							key: device2,
			...
			return /* @__PURE__ */ wp.element.createElement(
				wp.element.Fragment,
				null,
				/* @__PURE__ */ wp.element.createElement(CP.SelectDeviceToolbar, { attr: attributes, set: setAttributes, devices: CP.config.graphics.devicesForCss, defaultInput: "pc" }),
				/* @__PURE__ */ wp.element.createElement(
					BlockControls,
					null,
					device !== "pc" && /* @__PURE__ */ wp.element.createElement(ToolbarButton, { icon: "update", label: "update", onClick: copyFirstRect }),
					currentItemIndexes.length > 0 &&
						/* @__PURE__ */ wp.element.createElement(
							ToolbarGroup,
							{ label: "control" },
							currentItemIndexes.length === 1 &&
								/* @__PURE__ */ wp.element.createElement(ToolbarButton, {
									icon: "insert",
									label: "insert",
									onClick: () => {
							...
							currentItemIndexes.length > 1 &&
								/* @__PURE__ */ wp.element.createElement(ToolbarDropdownMenu, {
									...
									controls: [
										...
										{
											title: "Center",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "center" }),
											onClick: () => alignItems("center"),
										},
										{
											title: "Right",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "right" }),
											onClick: () => alignItems("right"),
										},
										{
											title: "Top",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "top" }),
											onClick: () => alignItems("top"),
										},
										{
											title: "Middle",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "middle" }),
											onClick: () => alignItems("middle"),
										},
										{
											title: "Bottom",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "bottom" }),
											onClick: () => alignItems("bottom"),
										},
										{
											title: "Even Left",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenLeft" }),
											onClick: () => alignItems("evenLeft"),
										},
										{
											title: "Even Center",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenCenter" }),
											onClick: () => alignItems("evenCenter"),
										},
										{
											title: "Even Right",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenRight" }),
											onClick: () => alignItems("evenRight"),
										},
										{
											title: "Even Top",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenTop" }),
											onClick: () => alignItems("evenTop"),
										},
										{
											title: "Even Middle",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenMiddle" }),
											onClick: () => alignItems("evenMiddle"),
										},
										{
											title: "Even Bottom",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenBottom" }),
											onClick: () => alignItems("evenBottom"),
										},
										{
											title: "Even Space Horizontal",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenSpaceH" }),
											onClick: () => alignItems("evenSpaceH"),
										},
										{
											title: "Even Space Vertical ",
											icon: /* @__PURE__ */ wp.element.createElement(CP.AlignmentIcon, { icon: "evenSpaceV" }),
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ id, className: clsx(classes, isSelected ? " cp-altcontent " + device : ""), ref: setContainerNode },
							isSelected && /* @__PURE__ */ wp.element.createElement(CP.Label, { icon: CP.devices[device].icon }),
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "_base" },
								states.hasBaseImage && /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.base, devices, device: device === "pc" ? null : device }),
							),
							isSelected &&
								/* @__PURE__ */ wp.element.createElement(CP.BoundingBox, {
							...
							items.map((item, index) => {
								...
								const itemBody = () => {
									if (itemSelected && currentItemIndexes.length === 1) {
										...
										return /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, {
											className: "_image",
											attr: attributes,
											set: setAttributes,
											devices,
									...
									if (itemStates.isText) {
										return /* @__PURE__ */ wp.element.createElement(
											"span",
											{ className: "_body" },
											itemStates.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h3", className: "_title", value: item.title }),
											itemStates.hasLead && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h4", className: "_lead", value: item.lead }),
											itemStates.hasText && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "p", className: "_text", value: item.text }),
										);
									}
								...
								return /* @__PURE__ */ wp.element.createElement(
									"span",
									{ id: id + "_item_" + index, className: itemClasses, "data-index": index, "data-rect": item.rect, ref: (el) => (targetRefs.current[index] = el), onClick: onClickItem, key: index },
									itemBody(),
								);
							}),
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						CP.SelectClassPanel,
						{ title: "\u30AF\u30E9\u30B9", icon: "art", set: setAttributes, attr: attributes, selectiveClasses, initialOpen: true },
						!states.hasBaseImage &&
							/* @__PURE__ */ wp.element.createElement(InputHeights, {
								value: heights,
		...
		save({ attributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ id, className: classes, "data-heights": heights },
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "_base" },
						states.hasBaseImage && /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.base, devices }),
					),
					items.map((item, index) => {
						var itemStates = CP.classNamesToFlags(item.classes);
						const itemBody = () => {
