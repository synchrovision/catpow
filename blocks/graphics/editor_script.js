	...
	wp.blocks.registerBlockType("catpow/graphics", {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ id, className: classes + (isSelected ? " cp-altcontent " + device : ""), ref: setContainerNode },
						...
						const itemBody = () => {
							...
							if (itemStates.isText) {
								return /* @__PURE__ */ wp.element.createElement(
									"span",
									{ className: "body" },
									itemStates.hasTitle && /* @__PURE__ */ wp.element.createElement("h3", { className: "title" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.title })),
									itemStates.hasLead && /* @__PURE__ */ wp.element.createElement("h4", { className: "lead" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.lead })),
									itemStates.hasText && /* @__PURE__ */ wp.element.createElement("p", { className: "text" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.text }))
								);
							}
