		...
		edit({ attributes, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ ...useBlockProps({ className: clsx(classes, { "is-open": isOpen }) }) },
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "_header", role: "button" },
							states.hasImage &&
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "_image" },
									states.isTemplate && imageCode
										...
										: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { set: setAttributes, attr: attributes, keys: imageKeys.image, size: imageSizes.image }),
								),
							/* @__PURE__ */ wp.element.createElement(RichText, { tagName: HeadingTag, className: "_title", value: title, onChange: (title2) => setAttributes({ title: title2 }) }),
							/* @__PURE__ */ wp.element.createElement("span", { className: "_icon", onClick: () => setAttributes({ isOpen: !isOpen }) }),
						),
						/* @__PURE__ */ wp.element.createElement(
							"div",
							{ className: "_contents" },
							/* @__PURE__ */ wp.element.createElement("div", { className: "_body" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null)),
						),
					),
				),
				/* @__PURE__ */ wp.element.createElement(
		...
		save({ attributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "_image" },
								states.isTemplate && imageCode ? imageCode : /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.image, size: "medium_large" }),
							),
					...
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ id: "{$uid}-contents", className: "_contents", "data-wp-bind--aria-hidden": "!callbacks.isOpen" },
						/* @__PURE__ */ wp.element.createElement("div", { className: "_body" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null)),
					),
				),
			);
		},
	...
	wp.blocks.registerBlockType("catpow/accordiongroup", {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement("div", { className: "cp-label" }, /* @__PURE__ */ wp.element.createElement(Icon, { icon: "excerpt-view" }), groupId),
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						PanelBody,
						{ title: "GroupId", icon: "admin-generic", initialOpen: true },
						/* @__PURE__ */ wp.element.createElement(TextControl, { onChange: (groupId2) => setAttributes({ groupId: groupId2 }), value: groupId }),
					),
				),
			);
		},
		save({ attributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				CP.Bem,
				{ prefix: "wp-block-catpow" },
				/* @__PURE__ */ wp.element.createElement("div", { ...blockProps }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null)),
			);
		},
	});
})();
