				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							"h3",
							{ className: "title" },
							/* @__PURE__ */ wp.element.createElement(RichText, { tagName: "div", value: title, onChange: (title2) => setAttributes({ title: title2 }) })
						),
						/* @__PURE__ */ wp.element.createElement("span", { className: "icon" })
					),
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "container" },
						/* @__PURE__ */ wp.element.createElement("div", { className: "contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))
					)
				),
				/* @__PURE__ */ wp.element.createElement(
					InspectorControls,
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement("h3", { className: "title" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: title })),
						/* @__PURE__ */ wp.element.createElement("span", { className: "icon" })
					),
					/* @__PURE__ */ wp.element.createElement(
						"div",
