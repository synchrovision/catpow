		...
		return wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					'div',
					{ 'class': 'label' },
					AltMode ? wp.element.createElement(Icon, { icon: 'welcome-comments' }) : content_path
				),
				wp.element.createElement(InnerBlocks, { template: [['catpow/t-loopcontent'], ['catpow/t-loopcontent', { name: 'on_empty' }]], templateLock: 'all' })
			),
			wp.element.createElement(
				InspectorControls,
				null,
...
registerBlockType('catpow/t-loopcontent', {
	...
	edit: function edit(_ref3) {
		...
		var template = name == 'on_empty' ? [['catpow/t-paragraph', { align: 'center', content: 'Not Found' }]] : [['catpow/t-paragraph']];
