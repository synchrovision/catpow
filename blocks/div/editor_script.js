				...
				const selectiveClasses2 = [
					...
					"colorScheme",
					{
						...
						sub: {
							...
							hasBackgroundImage: [{ input: "picture", label: "\u80CC\u666F\u753B\u50CF", keys: imageKeys2.backgroundImage, devices: devices2 }],
					...
					},
					{
						...
						type: "buttons",
						label: "\u4F59\u767D",
						values: { noPad: "\u306A\u3057", thinPad: "\u6975\u7D30", lightPad: "\u7D30", mediumPad: "\u4E2D", boldPad: "\u592A", heavyPad: "\u6975\u592A" },
					},
					"customMargin",
				];
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					states.hasBackgroundImage &&
						/* @__PURE__ */ wp.element.createElement(
							...
							/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { set: setAttributes, attr: attributes, keys: imageKeys.backgroundImage, devices })
						),
					/* @__PURE__ */ wp.element.createElement(InnerBlocks, { template: [["core/paragraph", { content: CP.dummyText.text }]], templateLock: false }),
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				states.hasBackgroundImage &&
					/* @__PURE__ */ wp.element.createElement(
						"div",
						{ className: "background" },
						/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.backgroundImage, devices })
					),
