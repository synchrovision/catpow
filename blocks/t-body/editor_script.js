	...
	wp.blocks.registerBlockType("catpow/t-body", {
		...
		edit({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				null,
				!isHtmlMail || TextMode
					? /* @__PURE__ */ wp.element.createElement(TextareaControl, { value: textMail, onChange: (textMail2) => setAttributes({ textMail: textMail2 }), rows: 20 })
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									/* @__PURE__ */ wp.element.createElement(
										...
										/* @__PURE__ */ wp.element.createElement(
											"td",
											null,
											/* @__PURE__ */ wp.element.createElement("div", { className: "wp-block-catpow-t-body__body__contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))
										)
									)
								),
								states.hasFooter &&
		...
		save({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				wp.element.Fragment,
				null,
				(!isHtmlMail || textMail) && /* @__PURE__ */ wp.element.createElement("textmail", null, textMail),
				isHtmlMail &&
					/* @__PURE__ */ wp.element.createElement(
						"table",
						...
						states.hasHeader &&
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									"tr",
									null,
									/* @__PURE__ */ wp.element.createElement("th", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: headerText }))
								)
							),
						/* @__PURE__ */ wp.element.createElement(
							"tbody",
							...
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									"td",
									null,
									/* @__PURE__ */ wp.element.createElement("div", { className: "wp-block-catpow-t-body__body__contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null))
								)
							)
						),
						states.hasFooter &&
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									"tr",
									null,
									/* @__PURE__ */ wp.element.createElement("td", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: footerText }))
								)
							)
					)
			);
