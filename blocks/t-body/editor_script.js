(() => {
  ...
  wp.blocks.registerBlockType("catpow/t-body", {
    ...
    edit({ attributes, className, setAttributes }) {
      ...
      )))), /* @__PURE__ */ wp.element.createElement("tbody", null, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { align: "center" }, /* @__PURE__ */ wp.element.createElement("div", { className: "-contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))))), states.hasFooter && /* @__PURE__ */ wp.element.createElement("tfoot", { className: footerClasses }, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { align: "center" }, /* @__PURE__ */ wp.element.createElement(
        RichText,
        {
    ...
    save({ attributes, className, setAttributes }) {
      ...
      var states = CP.classNamesToFlags(classes);
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, (!isHtmlMail || textMail) && /* @__PURE__ */ wp.element.createElement("textmail", null, textMail), isHtmlMail && /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement("table", { width: "100%", align: "center", className: classes }, states.hasHeader && /* @__PURE__ */ wp.element.createElement("thead", { className: headerClasses }, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("th", { align: "center" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: headerText })))), /* @__PURE__ */ wp.element.createElement("tbody", null, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { align: "center" }, /* @__PURE__ */ wp.element.createElement("div", { className: "-contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks.Content, null))))), states.hasFooter && /* @__PURE__ */ wp.element.createElement("tfoot", { className: footerClasses }, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { align: "center" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: footerText })))))));
    }
  });
})();
