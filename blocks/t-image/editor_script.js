registerBlockType('catpow/t-image', {
  ...
  attributes: {
    classes: {
      ...
      selector: 'table',
      attribute: 'class',
      default: 'wp-block-catpow-t-image'
    },
    src: {
      source: 'attribute',
      selector: '[src]',
  ...
  edit: function edit(_ref) {
    ...
    return [wp.element.createElement("table", {
      width: "100%",
      className: classes
    }, wp.element.createElement("tbody", null, wp.element.createElement("tr", null, wp.element.createElement("td", null, states.isTemplate ? wp.element.createElement("img", {
  ...
  save: function save(_ref2) {
    ...
    return wp.element.createElement("table", {
      width: "100%",
      className: classes
    }, wp.element.createElement("tbody", null, wp.element.createElement("tr", null, wp.element.createElement("td", null, states.isTemplate ? loopImage : wp.element.createElement("img", {
      width: "100%",
      height: "auto",
      src: src,
      alt: alt
