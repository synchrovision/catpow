  ...
  wp.blocks.registerBlockType("catpow/lightbox", {
    ...
    edit({ attributes, className, setAttributes, isSelected }) {
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(CP.SelectModeToolbar, { set: setAttributes, attr: attributes, modes: ["EditMode", "AltMode", "OpenMode"] }), /* @__PURE__ */ wp.element.createElement(InspectorControls, null, /* @__PURE__ */ wp.element.createElement(CP.SelectClassPanel, { title: "\u30AF\u30E9\u30B9", icon: "art", set: setAttributes, attr: attributes, selectiveClasses }), /* @__PURE__ */ wp.element.createElement(PanelBody, { title: "CLASS", icon: "admin-generic", initialOpen: false }, /* @__PURE__ */ wp.element.createElement(TextareaControl, { label: "\u30AF\u30E9\u30B9", onChange: (classes2) => setAttributes({ classes: classes2 }), value: classes }), /* @__PURE__ */ wp.element.createElement(TextareaControl, { label: "\u30DC\u30C3\u30AF\u30B9\u30AF\u30E9\u30B9", onChange: (sliderClasses2) => setAttributes({ sliderClasses: sliderClasses2 }), value: sliderClasses })), /* @__PURE__ */ wp.element.createElement(CP.SelectClassPanel, { title: "\u30EA\u30B9\u30C8\u30A2\u30A4\u30C6\u30E0", icon: "edit", set: setAttributes, attr: attributes, items, index: attributes.currentItemIndex, selectiveClasses: selectiveItemClasses }), /* @__PURE__ */ wp.element.createElement(CP.ItemControlInfoPanel, null)), !OpenMode ? /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, EditMode ? /* @__PURE__ */ wp.element.createElement("div", { ...blockProps }, /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(Icon, { icon: "edit" })), /* @__PURE__ */ wp.element.createElement(
        ...
        return /* @__PURE__ */ wp.element.createElement(CP.Item, { tag: "li", className: item.classes, set: setAttributes, attr: attributes, items, index, key: index }, /* @__PURE__ */ wp.element.createElement("div", { className: "_image" }, /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { className: "_img", attr: attributes, set: setAttributes, keys: imageKeys.thumbnail, index, size: "vga", isTemplate: states.isTemplate })), states.hasTitle && /* @__PURE__ */ wp.element.createElement("div", { className: "_text" }, /* @__PURE__ */ wp.element.createElement(
          RichText,
          {
            tagName: HeadingTag,
            className: "_title",
      ...
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement(
        ...
        /* @__PURE__ */ wp.element.createElement("ul", { className: "_items" }, items.map((item, index) => {
          return /* @__PURE__ */ wp.element.createElement(
            ...
            /* @__PURE__ */ wp.element.createElement("div", { className: "_image" }, /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "_img", attr: attributes, keys: imageKeys.thumbnail, index, isTemplate: states.isTemplate })),
            ...
            /* @__PURE__ */ wp.element.createElement("div", { className: "contents_" }, sliderStates.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: SliderHeadingTag, className: "_title", value: item.subTitle }), sliderStates.hasImage && /* @__PURE__ */ wp.element.createElement("div", { className: "_image" }, /* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { className: "_img", attr: attributes, keys: imageKeys.sliderImage, index, isTemplate: states.isTemplate })), sliderStates.hasText && /* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "div", className: "_text", value: item.text }))
          );
        })),
