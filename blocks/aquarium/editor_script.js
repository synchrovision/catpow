(() => {
  ...
  wp.blocks.registerBlockType("catpow/aquarium", {
    ...
    attributes: {
      ...
      layers: {
        ...
        default: [
          {
            classes: "layer h_120",
            items: [{ classes: "item center middle w_50 h_50 t_40 l_30", images: [], texts: [{ classes: "text top left w_100 h_100 t_0 l_0 hasTitle hasText", title: "Title", text: "Text" }] }]
          },
          {
            classes: "layer h_160",
            items: [{ classes: "item center middle w_50 h_50 t_60 l_70", images: [], texts: [{ classes: "text top left w_100 h_100 t_0 l_0 hasTitle hasText", title: "Title", text: "Text" }] }]
          }
        ]
      }
    },
    ...
    edit({ attributes, className, setAttributes }) {
      ...
      }), /* @__PURE__ */ wp.element.createElement("div", { className: "contents" }, /* @__PURE__ */ wp.element.createElement(InnerBlocks, null))), /* @__PURE__ */ wp.element.createElement(InspectorControls, null, /* @__PURE__ */ wp.element.createElement(CP.SelectClassPanel, { title: "\u30AF\u30E9\u30B9", icon: "art", set: setAttributes, attr: attributes, selectiveClasses })));
    },
