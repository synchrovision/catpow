			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ tag: "li", set: setAttributes, attr: attributes, items, index, isSelected, key: index },
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "image" },
							...
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									/* @__PURE__ */ wp.element.createElement(
										"span",
										{ className: "listPrice" },
										states.unitBefore && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit),
										/* @__PURE__ */ wp.element.createElement(
											"span",
											{ className: "number" },
											/* @__PURE__ */ wp.element.createElement(RichText2, {
										...
										states.unitAfter && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit)
									),
									/* @__PURE__ */ wp.element.createElement(
										"span",
										{ className: "price" },
					...
					/* @__PURE__ */ wp.element.createElement(
						...
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "image" },
								/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.image, index, size: "vga", isTemplate: states.isTemplate })
							),
						/* @__PURE__ */ wp.element.createElement(
							"header",
							null,
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "text" },
								states.hasTitle && /* @__PURE__ */ wp.element.createElement("h3", null, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: item.title })),
								states.hasTitle &&
									states.hasTitleCaption &&
									/* @__PURE__ */ wp.element.createElement("p", null, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: item.titleCaption })),
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "price" },
									/* @__PURE__ */ wp.element.createElement(
										...
										{ className: "listPrice" },
										states.unitBefore && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit),
										/* @__PURE__ */ wp.element.createElement("span", { className: "number" }, item.listPrice),
										states.unitAfter && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit)
									),
									/* @__PURE__ */ wp.element.createElement(
										"span",
										{ className: "price" },
										states.unitBefore && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit),
										/* @__PURE__ */ wp.element.createElement("span", { className: "number" }, item.price),
										states.unitAfter && /* @__PURE__ */ wp.element.createElement("span", { className: "unit" }, priceUnit)
									),
									/* @__PURE__ */ wp.element.createElement("span", { className: "priceCaption" }, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: priceCaption }))
								)
							)
						),
						(states.hasSubTitle || states.hasText || states.hasSpec || states.hasLink) &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "contents" },
								states.hasSubTitle && /* @__PURE__ */ wp.element.createElement("h4", null, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: item.subTitle })),
								states.hasText && /* @__PURE__ */ wp.element.createElement("p", null, /* @__PURE__ */ wp.element.createElement(RichText2.Content, { value: item.text })),
								states.hasSpec &&
									/* @__PURE__ */ wp.element.createElement(
										"dl",
										{ className: "spec" },
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									/* @__PURE__ */ wp.element.createElement(
										...
										/* @__PURE__ */ wp.element.createElement(
											...
											/* @__PURE__ */ wp.element.createElement("span", { className: "priceCaption" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: priceCaption }))
										)
									)
								),
								(states.hasSubTitle || states.hasText || states.hasSpec || states.hasLink) &&
