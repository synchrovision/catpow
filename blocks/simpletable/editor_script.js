registerBlockType('catpow/simpletable', {
  ...
  edit: function edit(_ref) {
    ...
    return [wp.element.createElement(InspectorControls, null, wp.element.createElement(CP.SelectClassPanel, {
      title: "\u30AF\u30E9\u30B9",
      icon: "art",
      set: setAttributes,
      attr: attributes,
      ...
      filters: CP.filters.simpletable || {}
    }), wp.element.createElement(CP.ItemControlInfoPanel, null)), wp.element.createElement("table", {
      className: classes
      ...
      }, wp.element.createElement("th", null, wp.element.createElement(RichText, {
        onChange: function onChange(text) {
          row.cells[0].text = text;
          saveItems();
        },
        value: row.cells[0].text
      })), wp.element.createElement("td", null, wp.element.createElement(RichText, {
        onChange: function onChange(text) {
