	...
	attributes:{
		...
		graph:{
			...
			default:[{
				...
				rowUnit:'日',
				rows:[
					{classes:'row weak',label:'1',vals:[{value:30},{value:40}]},
					{classes:'row normal',label:'2',vals:[{value:40},{value:60}]},
					{classes:'row strong',label:'3',vals:[{value:50},{value:80}]},
					{classes:'row strong',label:'4',vals:[{value:60},{value:100}]}
				],
				cols:[
					{classes:'col color1',label:'男性'},
					{classes:'col color2',label:'女性'},
				]
			}]
		}
	},
