registerBlockType('catpow/buttons', {
  ...
  icon: wp.element.createElement("svg", {
    ...
    d: "M19.5,11c0,2.8-2.2,5-5,5h-9c-2.8,0-5-2.2-5-5V9c0-2.8,2.2-5,5-5h9c2.8,0,5,2.2,5,5V11z M5.5,5c-2.2,0-4,1.8-4,4 c0,2.2,1.8,4,4,4h9c2.2,0,4-1.8,4-4c0-2.2-1.8-4-4-4H5.5z"
  })),
  category: 'catpow',
  example: CP.example,
  edit: function edit(props) {
    ...
    items.map(function (item, index) {
      ...
      }, item.text), isSelected && wp.element.createElement("span", {
        class: "url",
        onInput: function onInput(e) {
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(BlockControls, null, wp.element.createElement(CP.AlignClassToolbar, {
      set: setAttributes,
      attr: attributes
  ...
  save: function save(_ref) {
    ...
    items.map(function (item, index) {
      ...
      var shouldOpenWithOtherWindow = /^\w+:\/\//.test(item.url);
