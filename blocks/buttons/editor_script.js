			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ tag: "li", className: item.classes, set: setAttributes, attr: attributes, items, index, isSelected, key: index },
						/* @__PURE__ */ wp.element.createElement(
							CP.Link.Edit,
							{ className: "-button", attr: attributes, set: setAttributes, keys: linkKeys.link, index, isSelected },
					...
					EditMode
						...
						: /* @__PURE__ */ wp.element.createElement(
								...
								AltMode && doLoop
									...
									: /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes2 }, rtn))
						  )
				)
			);
		},
			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						...
						/* @__PURE__ */ wp.element.createElement(
							"a",
							{ href: item.url, className: "-button", target: shouldOpenWithOtherWindow ? "_blank" : null, rel: shouldOpenWithOtherWindow ? "noopener" : null, ...eventDispatcherAttributes },
							itemStates.hasIcon && /* @__PURE__ */ wp.element.createElement(CP.OutputIcon, { item }),
							item.text
						)
					)
						...
						rtn.push(
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									...
									itemStates.hasIcon &&
										/* @__PURE__ */ wp.element.createElement("span", { className: "icon" }, /* @__PURE__ */ wp.element.createElement("img", { src: item.iconSrc, alt: item.iconAlt })),
									item.text
								)
							)
						);
