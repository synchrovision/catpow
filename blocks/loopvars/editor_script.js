(() => {
  ...
  wp.blocks.registerBlockType("catpow/loopvars", {
    ...
    edit({ attributes, setAttributes, className }) {
      ...
      )) : /* @__PURE__ */ wp.element.createElement("div", { className: "embedded_content" }, /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, "LoopVars"), /* @__PURE__ */ wp.element.createElement(
        InnerBlocks,
        {
          template: [
            [
