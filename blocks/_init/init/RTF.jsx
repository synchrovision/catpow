    ...
    (e) => {
      if (e.key === "Tab") {
        ...
        const lineStart = Math.max(
          0,
          text.slice(0, e.currentTarget.selectionStart).lastIndexOf("\n")
        );
        const lineEnd =
          e.currentTarget.selectionEnd +
          Math.max(0, text.slice(e.currentTarget.selectionEnd).indexOf("\n"));
        ...
        e.target.value =
          text.slice(0, lineStart) + targetText + text.slice(lineEnd);
