...
export const BoundingBox = (props) => {
	...
	return (
		<div className={classes({ "is-doing-action": !!action })} style={style} ref={ref} onMouseDown={onMouseDown} onMouseMove={onMouseMove} onMouseUp={onMouseUp} onDoubleClick={onDoubleClick}>
			<div className={classes.controls()}>
				{controls.map((props, i) => (
					<span className={classes.controls.control(props.className)} data-control-action={props.action} data-control-flags={props.flags} key={i} />
				))}
			</div>
		</div>
	);
