...
import { PositionInput as PositionInputComponent } from "catpow/component/Input";
		...
		<CP.Bem prefix="cp">
			<div className="positioninput-">
				<div className="_input">
					<PositionInputComponent onChange={(pos) => onChange(positionToValue(pos))} {...pos} grid={showGrid ? 10 : 0} snap={showGrid} />
				</div>
