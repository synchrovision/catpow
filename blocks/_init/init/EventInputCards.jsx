      ...
      if (eventTypes && event.eventType) {
        ...
        if (eventType) {
          return Object.keys(eventParams).filter((paramName) => {
            return (
              eventParams[paramName].common ||
              eventType.options.indexOf(paramName) >= 0
            );
          });
        }
      }
          ...
          <CardBody className="cp-eventinputcard__body">
            ...
            {activeEventParamNames.map((paramName) => {
              ...
              return (
                <div
                  className={
                    "cp-eventinputcard__item is-type-" + (param.type || "text")
                  }
                  key={paramName}
                >
                  <div className="cp-eventinputcard__item__title">
                    {param.label}
                  </div>
                  <div className="cp-eventinputcard__item__inputs">
                    <CP.DynamicInput
