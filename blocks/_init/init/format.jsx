	...
	edit({ isActive, value, onChange }) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"Ruby"} onClick={onToggle} isActive={isActive} shortcutType={"primary"} shortcutCharacter={"r"} />
			</>
		);
	},
});
	...
	edit({ isActive, value, onChange }) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"small"} onClick={onToggle} isActive={isActive} shortcutType={"primary"} shortcutCharacter={"-"} />
			</>
		);
	},
});
	...
	H6.9L8.8,5.1z M20,18v2H0v-2H20z"
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"underline"} onClick={onToggle} isActive={isActive} shortcutType={"primary"} shortcutCharacter={"_"} />
			</>
		);
	},
});
	...
	edit(props) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"Title"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
	...
	edit(props) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"Mark"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
	...
	edit(props) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"Large"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
	...
	edit(props) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={"tag"} title={"tag"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
	...
	edit({ isActive, value, onChange }) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={icon} title={"annotation"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
	...
	edit(props) {
		...
		return (
			<>
				...
				<RichTextToolbarButton icon={"admin-generic"} title={"custom"} onClick={onToggle} isActive={isActive} />
			</>
		);
	},
});
