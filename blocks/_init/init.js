(() => {
  ...
  registerFormatType("catpow/ruby", {
    ...
    edit({ isActive, value, onChange }) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement(Fragment, null, /* @__PURE__ */ wp.element.createElement(
          RichTextShortcut,
          {
            type: "primary",
            character: "r",
  ...
  registerFormatType("catpow/title", {
    ...
    edit(props) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement(Fragment, null, isActive && /* @__PURE__ */ wp.element.createElement(Popover, { getAnchorRect: () => el.getBoundingClientRect(), position: "bottom left", focusOnMount: false }, /* @__PURE__ */ wp.element.createElement(Card, { size: "small" }, /* @__PURE__ */ wp.element.createElement(CardBody, null, /* @__PURE__ */ wp.element.createElement(
          CP.SelectButtons,
          {
            options: [
  ...
  registerFormatType("catpow/mark", {
    ...
    edit(props) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement(Fragment, null, isActive && /* @__PURE__ */ wp.element.createElement(Popover, { getAnchorRect: () => el.getBoundingClientRect(), position: "bottom center", focusOnMount: false }, /* @__PURE__ */ wp.element.createElement(Card, { size: "small" }, /* @__PURE__ */ wp.element.createElement(CardBody, null, /* @__PURE__ */ wp.element.createElement(
          CP.SelectThemeColor,
          {
  ...
  registerFormatType("catpow/tag", {
    ...
    edit(props) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement(Fragment, null, isActive && /* @__PURE__ */ wp.element.createElement(Popover, { getAnchorRect: () => el.getBoundingClientRect(), position: "bottom center", focusOnMount: false }, /* @__PURE__ */ wp.element.createElement(Card, null, /* @__PURE__ */ wp.element.createElement(CardBody, null, /* @__PURE__ */ wp.element.createElement(
          TextControl2,
          {
            label: "URL",
  ...
  registerFormatType("catpow/annotation", {
    ...
    edit({ isActive, value, onChange }) {
      ...
      return [
        /* @__PURE__ */ wp.element.createElement(Fragment, null, /* @__PURE__ */ wp.element.createElement(BlockControls, null, /* @__PURE__ */ wp.element.createElement(
          Toolbar,
          {
            controls: [
              { icon, onClick: onToggle, isActive }
  ...
  var CP2 = {
    ...
    selectImage: (keys, set, size, devices) => {
      if (CP2.uploder === void 0) {
        CP2.uploader = wp.media({
          title: "Select Image",
          button: { text: "Select" },
          multiple: false
        });
      }
      CP2.uploader.off("select").on("select", () => {
        let image = CP2.uploader.state().get("selection").first().toJSON();
        let data = {};
        if (keys.mime) {
    ...
    switchColor: (props, value) => {
      CP2.switchNumberClass(props, "color", value);
    },
    getColor: (props) => {
      return CP2.getNumberClass(props, "color");
    },
    switchPattern: (props, value) => {
      CP2.switchNumberClass(props, "pattern", value);
    },
    getPattern: (props) => {
      return CP2.getNumberClass(props, "pattern");
    },
    ...
    hasJsonValue: (prop, json, key, value) => {
      let values = CP2.getJsonValue(prop, json, key);
      if (!values) {
        return false;
      }
    ...
    switchJsonValue: (prop, json, key, value) => {
      ...
      CP2.setJsonValue(prop, json, key, values);
    },
    ...
    parseStyleCode: (code) => {
      ...
      for (const match of code.matchAll(/(\S.+?){([^}]+)}/g)) {
        rtn[match[1]] = CP2.parseStyleString(match[2]);
      }
      return rtn;
    },
    createStyleCode: (data) => {
      ...
      return Object.keys(data).map((sel) => {
        return sel + "{" + CP2.createStyleString(data[sel]) + "}";
      }).join("");
    },
    parseStyleCodeWithMediaQuery: (code) => {
      ...
      const defaultCode = code.replace(new RegExp(reg, "g"), (str) => {
        ...
        rtn[matches[1]] = CP2.parseStyleCode(matches[2]);
        return "";
      });
      rtn["default"] = CP2.parseStyleCode(defaultCode);
      return rtn;
    },
    createStyleCodeWithMediaQuery: (data) => {
      ...
      return Object.keys(data).map((media) => {
        ...
        if (media === "default") {
          return CP2.createStyleCode(data[media]);
        }
        return "@media(" + media + "){" + CP2.createStyleCode(data[media]) + "}";
      }).join("");
    },
    createGridStyleCode: (sel, bnd) => {
      return sel + "{" + CP2.createStyleString(CP2.createGridStyleCodeData(bnd)) + "}";
    },
    ...
    createGridItemStyleCode: (sel, bnd) => {
      return sel + "{" + CP2.createStyleString(CP2.createGridItemStyleCodeData(bnd)) + "}";
    },
    ...
    /*proxy*/
    finderProxy: (obj) => new Proxy(obj, CP2.finderProxyHandler),
    finderProxyHandler: {
      get: (obj, prop) => {
        ...
        if (typeof rtn === "object") {
          return new Proxy(rtn, CP2.finderProxyHandler);
        }
        return rtn;
      },
      set: (obj, prop, val) => {
    ...
    createBlocks: (blocks) => {
      return blocks.map((block) => {
        if (block[2]) {
          block[2] = CP2.createBlocks(block[2]);
        }
    ...
    getImageSizesForDevices: (devices) => {
      return Object.keys(CP2.devices).filter((device) => devices.includes(device)).map((device) => CP2.devices[device].sizes).join(",");
    },
    ...
    getPictureSoucesAttributesForDevices: (devices, selector, image) => {
      let attr = CP2.getPictureSoucesAttributes(selector);
      attr.default = CP2.getPictureSoucesAttributesDefaultValueForDevices(devices, image);
      return attr;
    },
    ...
    getMediaQueryKeyForDevice: (device) => {
      ...
      return CP2.devices[device].media_query.slice(1, -1);
    },
    ...
    getDataListId(name, values) {
      ...
      if (!document.getElementById(id)) {
        if (!values) {
          if (!CP2.dataListPresets.hasOwnProperty(name)) {
            return null;
          }
          values = CP2.dataListPresets[name];
        }
      ...
      wp.element.useEffect(() => {
        if (id && id.length > 2) {
          ...
          csss.map((key) => {
            ...
            atts.styleDatas[key] = CP2.parseStyleCodeWithMediaQuery(atts[key]);
          });
          setAttributes(atts);
        }
      }, [id]);
    ...
    SelectResponsiveImage: (props) => {
      ...
      if (device) {
        ...
        onClick = (e) => CP2.selectImage(keys, function(data) {
          if (keys.items) {
      ...
      if (isTemplate && keys.code && item[keys.code]) {
        return /* @__PURE__ */ wp.element.createElement(CP2.DummyImage, { text: item[keys.code] });
      }
      if (item[keys.mime]) {
      ...
      if (item[keys.srcset] && !sizes) {
        if (device) {
          sizes = CP2.devices[device].sizes_value;
        } else {
          sizes = CP2.getImageSizesForDevices(devices || ["sp", "pc"]);
        }
      }
      if (type == "video") {
        return /* @__PURE__ */ wp.element.createElement(
    ...
    ResponsiveImage: ({ className, attr, keys, index, sizes, devices, device, isTemplate }) => {
      ...
      if (item[keys.srcset] && !sizes) {
        devices = devices || ["sp", "pc"];
        sizes = CP2.getImageSizesForDevices(devices);
      }
      if (type == "video") {
        return /* @__PURE__ */ wp.element.createElement(
          "video",
    ...
    SelectPreparedImage: ({ className, name, value, color, onChange, ...otherProps }) => {
      ...
      CP2.cache.PreparedImage = CP2.cache.PreparedImage || {};
      if (state.images === null) {
        if (CP2.cache.PreparedImage[name]) {
          dispatch({ type: "update", images: CP2.cache.PreparedImage[name] });
        } else {
          wp.apiFetch({ path: "cp/v1/images/" + name }).then((images) => {
            CP2.cache.PreparedImage[name] = images;
    ...
    SelectPreparedImageSet: ({ className, name, value, color, onChange, ...otherProps }) => {
      ...
      CP2.cache.PreparedImageSets = CP2.cache.PreparedImageSets || {};
      if (state.imagesets === null) {
        if (CP2.cache.PreparedImageSets[name]) {
          dispatch({ type: "update", imagesets: CP2.cache.PreparedImageSets[name] });
        } else {
          wp.apiFetch({ path: "cp/v1/imageset/" + name }).then((imagesets) => {
            CP2.cache.PreparedImageSets[name] = imagesets;
    ...
    InputIcon: (props) => {
      return wp.element.createElement(CP2[wp.hooks.applyFilters("catpow.IconComponent", "StandardIcon")].Input, props);
    },
    OutputIcon: (props) => {
      return wp.element.createElement(CP2[wp.hooks.applyFilters("catpow.IconComponent", "StandardIcon")].Output, props);
    },
    StandardIcon: {
      Input: (props) => {
        ...
        return /* @__PURE__ */ wp.element.createElement(
          CP2.SelectPreparedImage,
          {
            name: prm.input,
            value: item[prm.keys.src],
            color: prm.color || CP2.getColor({ attr: item }) || 0,
            onChange: (image) => {
              save({
    ...
    DynamicInput: (props) => {
      ...
      const { options } = useMemo(() => {
        ...
        return CP2.parseSelections(param.options || param.values);
        ...
        default: {
          return /* @__PURE__ */ wp.element.createElement(
            TextControl,
            {
              ...
              value,
              onChange,
              list: param.list && CP2.getDataListId(param.list, param.values)
            }
          );
        }
      }
    ...
    SelectClassPanel: (props) => {
      ...
      let states = CP2.wordsToFlags(item[classKey]);
      ...
      const saveClasses = () => {
        save({ [classKey]: CP2.flagsToWords(states) });
      };
      const saveCss = (cssKey) => {
        set({ [cssKey]: CP2.createStyleCodeWithMediaQuery(styleDatas[cssKey]) });
      };
        ...
        if (prm.json) {
          if (prm.input) {
            switch (prm.input) {
                ...
                rtn.push(
                  /* @__PURE__ */ wp.element.createElement(
                    CP2.DynamicInput,
                    {
                      ...
                      onChange: (val) => {
                        CP2.setJsonValue(props, prm.json, prm.key, val);
                        if (prm.effect) {
              ...
              case "flag":
                let value = CP2.getJsonValue(props, prm.json, prm.key) || 0;
                if (prm.label) {
              ...
              case "color":
                ...
                rtn.push(
                  /* @__PURE__ */ wp.element.createElement(
                    ColorPicker,
                    {
                      color: CP2.getJsonValue(props, prm.json, prm.key) || "#FFFFFF",
                      onChangeComplete: (value2) => {
                        CP2.setJsonValue(props, prm.json, prm.key, value2.hex);
                      }
                    }
                  )
                );
              ...
              case "colors":
                ...
                rtn.push(
                  /* @__PURE__ */ wp.element.createElement(
                    CP2.SelectColors,
                    {
                      colors: CP2.getJsonValue(props, prm.json, prm.key) || [{ h: "40", s: "80%", l: "50%" }, { h: "60", s: "80%", l: "50%" }],
                      onChange: (colors) => {
                        CP2.setJsonValue(props, prm.json, prm.key, colors);
                      }
                    }
                  )
                );
              ...
              case "gradient":
                ...
                rtn.push(
                  /* @__PURE__ */ wp.element.createElement(
                    ...
                    {
                      onChange: (value2) => {
                        console.log(CP2.parseGradientStyleValue(value2));
                      }
                    }
                  )
                );
            ...
            let { options: options2, values: values2 } = CP2.parseSelections(prm.values);
            rtn.push(
              /* @__PURE__ */ wp.element.createElement(
                SelectControl,
                {
                  label: prm.label,
                  value: CP2.getJsonValue(props, prm.json, prm.key),
                  onChange: (val) => {
                    CP2.setJsonValue(props, prm.json, prm.key, val);
                  },
                  options: options2
            ...
            rtn.push(
              /* @__PURE__ */ wp.element.createElement(
                CheckboxControl,
                {
                  label: prm.label,
                  onChange: () => {
                    CP2.switchJsonValue(props, prm.json, prm.key, prm.values);
                  },
                  checked: CP2.hasJsonValue(props, prm.json, prm.key, prm.values)
                }
              )
            );
            if (prm.sub) {
          ...
          const { device = "pc" } = prm;
          const media = CP2.getMediaQueryKeyForDevice(device);
              ...
              case "pattern":
                rtn.push(
                  /* @__PURE__ */ wp.element.createElement(
                    ...
                    {
                      name: "pattern",
                      value: CP2.getUrlInStyleCode(tgt["background-image"]),
                      color: prm.color || 0,
                      onChange: (image) => {
                        if (!image.conf) {
                          return;
                        ...
                        if (width && height) {
                          ...
                          tgt["background-size"] = CP2.translateCssVal("background-size", size);
                        } else {
                          delete tgt["background-size"];
                        }
                        if (repeat) {
                          tgt["background-repeat"] = CP2.translateCssVal("background-repeat", repeat);
                        } else {
                    ...
                    CP2.SelectPreparedImageSet,
                    {
                      ...
                      onChange: (imageset) => {
                        imageset.map((image) => {
                          ...
                          const media2 = CP2.getMediaQueryKeyForDevice(device2);
          ...
          if (prm === "color") {
            rtn.push(
              /* @__PURE__ */ wp.element.createElement(
                CP2.SelectColorClass,
                {
                  ...
                  onChange: (color) => {
                    CP2.filterFlags(states, (key) => !/^color\d+/.test(key));
                    states[color] = true;
                    if (!items) {
            ...
            rtn.push(
              /* @__PURE__ */ wp.element.createElement(
                CP2.SelectPatternClass,
                {
                  ...
                  onChange: (pattern) => {
                    CP2.filterFlags(states, (key) => !/^pattern\d+/.test(key));
                    states[pattern] = true;
                    saveClasses();
                  }
                }
            ...
            switch (prm.input) {
              ...
              case "icon":
                ...
                rtn.push(/* @__PURE__ */ wp.element.createElement(CP2.InputIcon, { prm, item, save }));
                break;
              case "symbol":
              case "pattern":
                prm.keys = prm.keys || {};
            ...
            let subClasses = CP2.getSubClasses(prm);
            let bindClasses = CP2.getBindClasses(prm);
            var { options, values } = CP2.parseSelections(prm.values);
      ...
      if (triggerClasses && triggerClasses.item) {
        const blockStates = CP2.wordsToFlags(attr.classes);
    ...
    AlignClassToolbar: (props) => {
      ...
      return /* @__PURE__ */ wp.element.createElement(
        ...
        {
          value: CP2.getSelectiveClass(props, aligns),
          controls: props.aligns || aligns,
          onChange: (align) => {
            CP2.switchSelectiveClass(props, aligns, align, props.key);
          }
        }
      );
    },
      ...
      return /* @__PURE__ */ wp.element.createElement(BaseControl, { label, help }, /* @__PURE__ */ wp.element.createElement("table", { className: "selectPosition" }, /* @__PURE__ */ wp.element.createElement("tbody", null, rows.map((cols) => /* @__PURE__ */ wp.element.createElement("tr", null, cols.map((col) => {
        ...
        return /* @__PURE__ */ wp.element.createElement(
          "td",
          {
            ...
            onClick: () => {
              if (itemsKey) {
                CP2.switchItemSelectiveClass(props, values, col, props.key);
              } else {
    ...
    EditItemsTable: (props) => {
      ...
      return /* @__PURE__ */ wp.element.createElement("table", { className: "editItemsTable" }, /* @__PURE__ */ wp.element.createElement("thead", null, /* @__PURE__ */ wp.element.createElement("tr", null, columns.map((col) => !("cond" in col) || col.cond ? /* @__PURE__ */ wp.element.createElement("th", null, col.label || col.key) : false), /* @__PURE__ */ wp.element.createElement("th", null))), /* @__PURE__ */ wp.element.createElement("tbody", null, items.map((item, index) => {
        ...
        return /* @__PURE__ */ wp.element.createElement(
          ...
          /* @__PURE__ */ wp.element.createElement("td", null, /* @__PURE__ */ wp.element.createElement("div", { className: "itemControl" }, /* @__PURE__ */ wp.element.createElement("div", { className: "btn delete", onClick: (e) => CP2.deleteItem(propsForControl) }), /* @__PURE__ */ wp.element.createElement("div", { className: "btn clone", onClick: (e) => CP2.cloneItem(propsForControl) }), /* @__PURE__ */ wp.element.createElement("div", { className: "btn up", onClick: (e) => CP2.upItem(propsForControl) }), /* @__PURE__ */ wp.element.createElement("div", { className: "btn down", onClick: (e) => CP2.downItem(propsForControl) })))
        );
      })));
    },
    DummyImage: ({ text }) => {
      ...
      const EventInputCard = useCallback((props2) => {
        ...
        return /* @__PURE__ */ wp.element.createElement(Card, { className: "EventInputCard" }, /* @__PURE__ */ wp.element.createElement(CardHeader, { className: "EventInputCard__header" }, /* @__PURE__ */ wp.element.createElement(Flex, null, /* @__PURE__ */ wp.element.createElement(FlexBlock, null, title), /* @__PURE__ */ wp.element.createElement(FlexItem, null, /* @__PURE__ */ wp.element.createElement(
          ...
          TextControl,
          {
            ...
            list: CP2.getDataListId(processerId + "EventTypes", eventTypeList)
          }
          ...
          TextControl,
          {
            ...
            list: CP2.getDataListId(props2.eventList || "mouseEvent")
          }
  ...
  CP2.example = {
    attributes: {
      title: [CP2.dummyText.title],
      headerText: [CP2.dummyText.title],
      footerText: [CP2.dummyText.footer],
      read: [CP2.dummyText.lead],
      text: [CP2.dummyText.text]
    },
    innerBlocks: [
      {
        name: "core/paragraph",
        attributes: {
          content: CP2.dummyText.text
        }
      }
    ]
  };
