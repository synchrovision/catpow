		...
		return (
			<ul>
				{meta.map((item)=>(
					<li>
						<h5>{item.name}</h5>
						{item.meta.length>0 && <div className="sub"><RenderMeta meta={item.meta}/></div>}
					</li>
				))}
			</ul>
		);
    ...
    return [
        ...
        <PluginSidebar
            ...
            icon={
				<svg role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-hidden="true">
					<g>
						<path d="M10.1,14.5c0-0.9,0.5-1.4,1.3-1.5c0.6-0.1,1.1-0.5,1.6-0.8c0.8-0.5,2.3-0.4,3,0.1c0.4,0.3,0.8,0.6,1,1.1
						...
						<path d="M2.8,8.6c0.3-1,0.5-2.2,0.9-3.3c0.3-0.8,1.9-1.3,2.7-1c0.9,0.3,1.7,0.9,2.5,1.4c0.5,0.3,1.1,0.5,1.4,1.1
							c0.2,0.5,0.2,0.9,0,1.4c-0.6,1.2-1.7,1-2.7,1.1c-0.8,0.1-1.4,0.5-2,0.9c-0.5,0.3-1,0.5-1.6,0.4C3.2,10.2,2.7,9.7,2.8,8.6z"/>
						<path d="M4.9,2.2C4.8,2.8,4.8,3.6,4,3.9C3.5,4.1,3.2,3.8,2.9,3.5C2,2.6,2.2,1.6,2.7,0.6c0.2-0.3,0.5-0.5,0.9-0.4
							c0.4,0,0.7,0.3,0.9,0.6C4.8,1.2,4.9,1.7,4.9,2.2z"/>
						<path d="M1,3.5c0.8,0,1.3,0.8,1.5,1.4c0.2,0.7,0.1,1.2-0.4,1.7C1.6,7.1,0.9,6.8,0.5,6.2C0.1,5.6,0.1,4.9,0.2,4.3
							C0.2,3.8,0.4,3.4,1,3.5z"/>
						<path d="M5.8,1.8c0-1.2,0.4-1.6,1.3-1.5c0.6,0.1,1,0.6,1.1,1.2c0.1,0.8,0,1.5-0.6,2.1C7.1,4,6.7,3.7,6.5,3.4C6,3,5.7,2.4,5.8,1.8z
							"/>
						...
						<path d="M18.9,17.7c-0.7,0-1.2-0.9-1-1.5c0.2-0.4,0.1-0.8,0.4-1.2c0.3-0.3,1.2-0.3,1.4,0.1c0.4,0.8,0.3,1.7-0.3,2.4
        ...
        >
			...
			{structure && Object.keys(structure).map((data_type)=>{
				return (
					<PanelBody title={data_type} initialOpen={false}>
						{structure[data_type].map((item)=>(
							<PanelBody title={item.name} initialOpen={false}>
								<RenderMeta meta={item.meta}/>
							</PanelBody>
						))}
					</PanelBody>
				)
