...
wp.hooks.addFilter('blocks.registerBlockType', 'catpow/editor', function (settings, name) {
	switch (name) {
		case 'core/heading':
			settings.attributes.className.default = 'is-style-headline';break;
		case 'core/paragraph':
			settings.attributes.fontSize.default = 'regular';break;
		case 'core/list':
			settings.attributes.className.default = 'is-style-check';break;
		case 'core/columns':
			settings.attributes.className.default = 'is-style-panel';break;
	}
	return settings;
});

// core/columnsでregisterBlockStyleがエラーを起こすバグの回避
wp.hooks.addFilter('editor.BlockEdit', 'catpow/editor', wp.compose.createHigherOrderComponent(function (BlockEdit) {
