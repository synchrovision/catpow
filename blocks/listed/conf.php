...
$attributes=[
	...
	"classes"=>["source"=>"attribute","selector"=>"ul","attribute"=>"class","default"=>"wp-block-catpow-listed is-level3 is-type-card has-content-width has-spacing-type-block has-item-size-medium has-header has-title has-title-caption has-image has-text has-link"],
