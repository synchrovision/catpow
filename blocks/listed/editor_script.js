			...
			[...Array(Math.max(items.length, loopCount)).keys()].forEach((i) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ tag: "li", set: setAttributes, attr: attributes, items, index, isSelected, key: i },
						states.hasImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "image" },
								/* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { attr: attributes, set: setAttributes, keys: imageKeys.image, index, size: "vga", isTemplate: states.isTemplate })
							),
						states.hasHeader &&
							/* @__PURE__ */ wp.element.createElement(
								"header",
								...
								states.hasCounter &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "counter" },
										countPrefix && /* @__PURE__ */ wp.element.createElement("span", { className: "prefix" }, countPrefix),
										/* @__PURE__ */ wp.element.createElement("span", { className: "number" }, index + 1),
										countSuffix && /* @__PURE__ */ wp.element.createElement("span", { className: "suffix" }, countSuffix)
									),
							...
							/* @__PURE__ */ wp.element.createElement(
								...
								states.hasSubCounter &&
									/* @__PURE__ */ wp.element.createElement(
										...
										subCountPrefix && /* @__PURE__ */ wp.element.createElement("span", { className: "prefix" }, subCountPrefix),
										/* @__PURE__ */ wp.element.createElement("span", { className: "number" }, index + 1),
										subCountSuffix && /* @__PURE__ */ wp.element.createElement("span", { className: "suffix" }, subCountSuffix)
									),
								states.hasSubImage &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
						...
						states.hasBackgroundImage &&
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { attr: attributes, set: setAttributes, keys: imageKeys.backgroundImage, index, isTemplate: states.isTemplate })
							),
						states.hasLink &&
							isSelected &&
							/* @__PURE__ */ wp.element.createElement(
				...
				EditMode
					...
					: /* @__PURE__ */ wp.element.createElement(
							...
							AltMode && doLoop
								...
								: /* @__PURE__ */ wp.element.createElement("ul", { ...blockProps }, rtn)
					  )
			);
		},
						...
						states.hasHeader &&
							/* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement(
									"div",
									{ className: "text" },
									states.hasTitle && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: TitleTag, className: "title", value: item.title }),
									states.hasTitle && states.hasTitleCaption && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: "p", className: "titlecaption", value: item.titleCaption })
								)
							),
						(states.hasSubImage || states.hasSubTitle || states.hasText) &&
							/* @__PURE__ */ wp.element.createElement(
								...
								states.hasSubImage &&
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "image" },
										/* @__PURE__ */ wp.element.createElement(CP.ResponsiveImage, { attr: attributes, keys: imageKeys.subImage, index, isTemplate: states.isTemplate })
									),
								states.hasSubTitle && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: SubTitleTag, className: "subtitle", value: item.subTitle }),
								states.hasText && /* @__PURE__ */ wp.element.createElement(RichText2.Content, { tagName: "p", className: "text", value: item.text })
							),
						states.hasBackgroundImage &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								...
								states.hasHeader &&
									/* @__PURE__ */ wp.element.createElement(
										...
										/* @__PURE__ */ wp.element.createElement(
											...
											states.hasTitle &&
												states.hasTitleCaption &&
												/* @__PURE__ */ wp.element.createElement("p", null, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.titleCaption }))
										)
									),
								(states.hasSubImage || states.hasSubTitle || states.hasText) &&
									/* @__PURE__ */ wp.element.createElement(
