    ...
    from: [
      {
        ...
        transform: (attributes) => {
          attributes.classes =
            "wp-block-catpow-listed menu medium hasHeader hasTitle hasTitleCaption hasImage hasText";
            ...
            <div className="contents">
              {states.hasSubCounter && (
                <div className="subcounter">
                  {subCountPrefix && (
                    <span className="prefix">{subCountPrefix}</span>
                  )}
                  <span className="number">{index + 1}</span>
                  {subCountSuffix && (
                    <span className="suffix">{subCountSuffix}</span>
                  )}
                </div>
              )}
              {states.hasSubImage && (
              ...
              {states.hasHeader && (
                <header>
                  {states.hasCounter && (
                    <div className="counter">
                      {countPrefix && (
                        <span className="prefix">{countPrefix}</span>
                      )}
                      <span className="number">{index + 1}</span>
                      {countSuffix && (
                        <span className="suffix">{countSuffix}</span>
                      )}
                    </div>
                  )}
                  {states.hasHeaderImage && (
