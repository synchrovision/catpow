	...
	wp.blocks.registerBlockType("catpow/pageheader", {
		...
		edit({ attributes, setAttributes, className, clientId }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ className: attributes.classes, style: vars },
					/* @__PURE__ */ wp.element.createElement(
						"div",
						...
						states.hasBreadCrumnb &&
							/* @__PURE__ */ wp.element.createElement(CP.ServerSideRenderPart.Preview, { name: "breadcrumb", className: classes.body.breadcrumb(), container_class: classes.body.breadcrumb.body() })
					),
					/* @__PURE__ */ wp.element.createElement(
						"div",
						...
						states.hasBackgroundImage &&
							/* @__PURE__ */ wp.element.createElement(
								...
								states.isTemplate && backgroundImageCode
									...
									: /* @__PURE__ */ wp.element.createElement(CP.SelectResponsiveImage, { attr: attributes, set: setAttributes, keys: imageKeys.backgroundImage, devices })
							)
					)
				)
			);
		...
		save({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				"div",
				{ className: classes(), style: vars },
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ className: classes.body() },
					/* @__PURE__ */ wp.element.createElement(RichText.Content, { tagName: "h1", className: classes.body.title(), value: attributes.title }),
					states.hasBreadCrumnb &&
						/* @__PURE__ */ wp.element.createElement(CP.ServerSideRenderPart, { name: "breadcrumb", className: classes.body.breadcrumb(), container_class: classes.body.breadcrumb.body() })
				),
				/* @__PURE__ */ wp.element.createElement(
					"div",
					{ className: classes.background() },
