  ...
  wp.blocks.registerBlockType("catpow/t-button", {
    ...
    edit({ attributes, className, setAttributes }) {
      ...
      const selectiveClasses = useMemo(() => {
        const selectiveClasses2 = ["color", "size", { name: "url", input: "text", label: "URL", key: "url" }];
        wp.hooks.applyFilters("catpow.blocks.t-button.selectiveClasses", CP.finderProxy(selectiveClasses2));
        return selectiveClasses2;
      }, []);
      return /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement("table", { className: classes, align: "center", width: "100%" }, /* @__PURE__ */ wp.element.createElement("tbody", null, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_", colspan: "3" })), /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_" }), /* @__PURE__ */ wp.element.createElement("td", { className: "button_" }, /* @__PURE__ */ wp.element.createElement("a", { className: "_link" }, /* @__PURE__ */ wp.element.createElement(
        RichText,
        {
          onChange: (title2) => {
    ...
    save({ attributes, className, setAttributes }) {
      ...
      return /* @__PURE__ */ wp.element.createElement(CP.Bem, { prefix: "wp-block-catpow" }, /* @__PURE__ */ wp.element.createElement("table", { className: classes, align: "center", width: "100%" }, /* @__PURE__ */ wp.element.createElement("tbody", null, /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_", colspan: "3" })), /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_" }), /* @__PURE__ */ wp.element.createElement("td", { className: "button_" }, /* @__PURE__ */ wp.element.createElement("a", { className: "_link", href: url }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: title }))), /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_" })), /* @__PURE__ */ wp.element.createElement("tr", null, /* @__PURE__ */ wp.element.createElement("td", { className: "spacer_", colspan: "3" })))));
    }
  });
})();
