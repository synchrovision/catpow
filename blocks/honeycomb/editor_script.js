...
registerBlockType('catpow/honeycomb', {
  ...
  icon: wp.element.createElement("svg", {
    ...
    d: "M282.6,176.3l71.7,41.4v82.8l-71.7,41.4L211,300.4v-82.8L282.6,176.3 M282.6,168l-78.9,45.5v91.1l78.9,45.5l78.9-45.5 v-91.1L282.6,168L282.6,168z"
  }), wp.element.createElement("polygon", {
    points: "120.9,357 120.9,448 199.7,493.6 278.6,448 278.6,357 199.7,311.5 \t"
  }), wp.element.createElement("polygon", {
    points: "30.9,214 30.9,305 109.7,350.6 188.6,305 188.6,214 109.7,168.5 \t"
  }), wp.element.createElement("polygon", {
    points: "117.9,65 117.9,156 196.7,201.6 275.6,156 275.6,65 196.7,19.5 \t"
  }), wp.element.createElement("polygon", {
    points: "290.4,357.9 290.4,449 369.3,494.5 448.1,449 448.1,357.9 369.3,312.4 \t"
  })),
  category: 'catpow',
  attributes: {
    id: {
      source: 'attribute',
      selector: '.wp-block-catpow-honeycomb',
      attribute: 'id',
      default: ''
    },
    classes: {
      ...
      selector: '.wp-block-catpow-honeycomb',
      attribute: 'class',
      default: 'wp-block-catpow-honeycomb hasBaseImage'
    },
    breakpoints: {
      source: 'attribute',
      selector: '.wp-block-catpow-honeycomb',
      'attribute': 'data-breakpoints',
      default: '480,960'
    },
    grid: {
      source: 'attribute',
  ...
  edit: function edit(_ref) {
    ...
    if (!id) {
      setAttributes({
        id: 'hnc' + new Date().getTime().toString(16)
      });
    }
    ...
    var itemHandler = [wp.element.createElement("div", {
      ...
      "data-drawaction": "move"
    }, wp.element.createElement(Icon, {
      icon: "move"
    })), wp.element.createElement("div", {
      className: "handler clone",
      "data-drawaction": "clone"
    }, wp.element.createElement(Icon, {
      icon: "plus-alt"
    })), wp.element.createElement("div", {
      className: "handler delete",
      "data-drawaction": "delete"
    }, wp.element.createElement(Icon, {
      icon: "dismiss"
    }))];
    ...
    return [wp.element.createElement(BlockControls, null, wp.element.createElement(CP.SelectBreakPointToolbar, {
    ...
    })), wp.element.createElement(Catpow.DrawArea, {
      id: id,
      className: classes,
      ...
      return wp.element.createElement(Catpow.Hexagon, (_wp$element$createEle = {
        id: itemID,
      ...
      }), _wp$element$createEle), itemStates.hasTitle && wp.element.createElement("h3", null, wp.element.createElement(RichText, {
        placeholder: "Title",
    ...
    }), wp.element.createElement("style", null, CP.createStyleCode(cssDatas[attributes.bp]))), wp.element.createElement(InspectorControls, null, wp.element.createElement(PanelBody, {
      title: "Grid",
      icon: "admin-links",
      initialOpen: false
  ...
  save: function save(_ref2) {
    ...
    return wp.element.createElement("div", {
      ...
      return wp.element.createElement(Catpow.Hexagon, {
        id: itemID,
    ...
    }), wp.element.createElement("style", null, breakpoints.map(function (bp) {
      if ('0' == bp) {
