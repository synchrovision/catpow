(() => {
	...
	wp.blocks.registerBlockType("catpow/honeycomb", {
		...
		icon: /* @__PURE__ */ wp.element.createElement(
			...
			/* @__PURE__ */ wp.element.createElement("polygon", { points: "120.9,357 120.9,448 199.7,493.6 278.6,448 278.6,357 199.7,311.5 	" }),
			/* @__PURE__ */ wp.element.createElement("polygon", { points: "30.9,214 30.9,305 109.7,350.6 188.6,305 188.6,214 109.7,168.5 	" }),
			/* @__PURE__ */ wp.element.createElement("polygon", { points: "117.9,65 117.9,156 196.7,201.6 275.6,156 275.6,65 196.7,19.5 	" }),
			/* @__PURE__ */ wp.element.createElement("polygon", { points: "290.4,357.9 290.4,449 369.3,494.5 448.1,449 448.1,357.9 369.3,312.4 	" })
		),
		category: "catpow",
		attributes: {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					BlockControls,
					null,
					/* @__PURE__ */ wp.element.createElement(CP.SelectBreakPointToolbar, { breakpoints, value: attributes.bp, onChange: (bp) => setAttributes({ bp }) })
				),
				/* @__PURE__ */ wp.element.createElement(
					Catpow.DrawArea,
					{
		...
		save({ attributes, className, setAttributes }) {
			...
			return /* @__PURE__ */ wp.element.createElement(
				"div",
				{ id, className: classes, "data-breakpoints": breakpoints, "data-grid": grid },
				items.map((item, index) => {
					var itemID = id + "_item_" + index;
					var itemStates = CP.classNamesToFlags(item.classes);
					...
					return /* @__PURE__ */ wp.element.createElement(
						Catpow.Hexagon,
						{ id: itemID, className: item.classes, src: itemStates.hasImage ? item.src : false, "data-order": item.order, key: index },
