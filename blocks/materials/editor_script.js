			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						CP.Item,
						{ tag: "li", set: setAttributes, attr: attributes, items, index, isSelected: isSelected && currentItemIndex == index, key: index },
						itemStates.hasLabel &&
							/* @__PURE__ */ wp.element.createElement(
								"div",
								{ className: "label" },
			...
			items.map((item, index) => {
				...
				rtn.push(
					/* @__PURE__ */ wp.element.createElement(
						...
						itemStates.hasLabel && /* @__PURE__ */ wp.element.createElement("div", { className: "label" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: item.label })),
						/* @__PURE__ */ wp.element.createElement(
							"ul",
							{ className: "items" },
							item.items.map((subItem, subIndex) => {
								...
								return /* @__PURE__ */ wp.element.createElement(
									...
									/* @__PURE__ */ wp.element.createElement(
										"div",
										{ className: "text" },
										/* @__PURE__ */ wp.element.createElement("div", { className: "title" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: subItem.title })),
										/* @__PURE__ */ wp.element.createElement("div", { className: "line" }),
										/* @__PURE__ */ wp.element.createElement("div", { className: "amount" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: subItem.amount })),
										subItemStates.hasCaption &&
											/* @__PURE__ */ wp.element.createElement("div", { className: "caption" }, /* @__PURE__ */ wp.element.createElement(RichText.Content, { value: subItem.caption }))
									)
								);
							})
						)
