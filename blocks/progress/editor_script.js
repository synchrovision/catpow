	...
	wp.blocks.registerBlockType("catpow/progress", {
		...
		edit({ attributes, className, setAttributes, isSelected }) {
			...
			const CenterSpinner = useCallback(
				(props) =>
					/* @__PURE__ */ wp.element.createElement(Flex, { justify: "center" }, /* @__PURE__ */ wp.element.createElement(FlexItem, null, /* @__PURE__ */ wp.element.createElement(Spinner, null))),
				[]
			);
			useEffect(() => {
			...
			return /* @__PURE__ */ wp.element.createElement(
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					settings
						? /* @__PURE__ */ wp.element.createElement(
								CP.SelectClassPanel,
								{ title: "\u8A2D\u5B9A", initialOpen: false, icon: "admin-generic", set: setSettings, attr: settings, selectiveClasses: settingsSelectiveClasses },
								/* @__PURE__ */ wp.element.createElement(CP.EditItemsTable, { set: setSettings, attr: settings, columns: [{ type: "text", key: "label" }] }),
								!isWaiting
									? /* @__PURE__ */ wp.element.createElement(
											wp.element.Fragment,
											null,
											/* @__PURE__ */ wp.element.createElement(
												...
												/* @__PURE__ */ wp.element.createElement(
													FlexItem,
													null,
													/* @__PURE__ */ wp.element.createElement(Button, { isPrimary: true, onClick: updateSettings }, "\u8A2D\u5B9A\u3092\u66F4\u65B0")
												)
											),
											/* @__PURE__ */ wp.element.createElement(
												Flex,
												...
												/* @__PURE__ */ wp.element.createElement(
													FlexItem,
													null,
													/* @__PURE__ */ wp.element.createElement(Button, { isLink: true, onClick: registerSettings }, "\u767B\u9332"),
													"\uFF5C",
													/* @__PURE__ */ wp.element.createElement(Button, { isLink: true, isDestructive: true, onClick: deleteSettings }, "\u524A\u9664")
												)
											)
									  )
				...
				/* @__PURE__ */ wp.element.createElement(
					...
					settings
						? /* @__PURE__ */ wp.element.createElement(
								...
								/* @__PURE__ */ wp.element.createElement("ul", { className: "items" }, /* @__PURE__ */ wp.element.createElement(Items, null))
						  )
						: /* @__PURE__ */ wp.element.createElement(CenterSpinner, null)
				)
			);
