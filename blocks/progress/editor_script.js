registerBlockType('catpow/progress', {
  ...
  edit: function edit(_ref) {
    ...
    var save = useCallback(function () {
      setAttributes({
        items: JSON.parse(JSON.stringify(attributes.items))
      });
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(CP.SelectModeToolbar, {
      ...
      value: classes
    })), wp.element.createElement(CP.ItemControlInfoPanel, null)), wp.element.createElement(Fragment, null, wp.element.createElement("div", {
      className: classes
