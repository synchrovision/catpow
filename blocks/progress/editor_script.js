  ...
  wp.blocks.registerBlockType("catpow/progress", {
    ...
    edit({ attributes, className, setAttributes, isSelected }) {
      ...
      const Items = useCallback((props) => {
        ...
        const states2 = CP.wordsToFlags(settings.classes);
      ...
      const CenterSpinner = useCallback((props) => /* @__PURE__ */ wp.element.createElement(Flex, { justify: "center" }, /* @__PURE__ */ wp.element.createElement(FlexItem, null, /* @__PURE__ */ wp.element.createElement(Spinner, null))), []);
      useEffect(() => {
      ...
      ), settings ? /* @__PURE__ */ wp.element.createElement(
        CP.SelectClassPanel,
        {
          title: "\u8A2D\u5B9A",
          initialOpen: false,
