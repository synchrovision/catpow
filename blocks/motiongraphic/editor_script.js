...
registerBlockType('catpow/motiongraphic', {
	...
	edit: function edit(_ref) {
		...
		if (!selections) {
			wp.apiFetch({ path: 'cp/v1/blocks/config/motiongraphic/selections' }).then(function (res) {
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					...
					wp.element.createElement(
						...
						SelectedComponent ? wp.element.createElement(
							Catpow.FixedBG,
							null,
							wp.element.createElement(
								Catpow.Animation,
								null,
								wp.element.createElement(SelectedComponent, JSON.parse(props))
							)
						) : wp.element.createElement(
							'p',
							null,
