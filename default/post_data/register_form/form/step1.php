...
$metas_primary=[];
$metas_has_children=[];
foreach(\cp::$config['user_datas'][$role]['meta'] as $name=>$conf){
...
?>
<!-- wp:catpow/section -->
<section class="wp-block-catpow-section center column round thin_border check"><div class="contents"><header><div class="title"><h2><?=\cp::$config['user_datas'][$role]['label']?>登録</h2></div></header><div class="text"><!-- wp:catpow/simpletable -->
