var app = function app(props) {
	...
	var App = useCallback(function (props) {
		...
		return wp.element.createElement(
			Catpow.Transition,
			null,
			state.wait ? wp.element.createElement(
				Fragment,
				{ depth: 0 },
				wp.element.createElement(Catpow.Spinner, null)
				...
				wp.element.createElement(Focused, null)
				...
				wp.element.createElement(
					Main,
					null,
					wp.element.createElement(SearchResults, null)
				),
