(() => {
  ...
  var MainMenu = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: classes() }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.items() }, menuData.items.map((item2, index) => /* @__PURE__ */ wp.element.createElement("li", { className: classes.items.item(), key: index }, /* @__PURE__ */ wp.element.createElement("a", { className: classes.items.item.link(), href: item2.link && item2.link.url }, /* @__PURE__ */ wp.element.createElement("span", { className: classes.items.item.link.title() }, item2.title), /* @__PURE__ */ wp.element.createElement("span", { className: classes.items.item.link.name() }, item2.name))))));
  };
  ...
  var PrimaryMenu = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: classes() }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.items() }, menuData.items.map((item2, index) => /* @__PURE__ */ wp.element.createElement("li", { className: classes.items.item(), key: index }, /* @__PURE__ */ wp.element.createElement("a", { className: classes.items.item.link(), href: item2.link && item2.link.url, target: null }, /* @__PURE__ */ wp.element.createElement("span", { className: classes.items.item.link.title() }, item2.title), /* @__PURE__ */ wp.element.createElement("span", { className: classes.items.item.link.name() }, item2.name))))));
  };
