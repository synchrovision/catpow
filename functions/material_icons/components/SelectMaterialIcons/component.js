(() => {
  ...
  // ../functions/material_icons/components/SelectMaterialIcons/materiaIconNames.json
  var materiaIconNames_default = [
    "10k",
    "10mp",
    "11mp",
    "123",
  ...
  // ../functions/material_icons/components/SelectMaterialIcons/component.jsx
  Catpow.SelectMaterialIcons = (props) => {
    ...
    const [state, dispatch] = useReducer2(
      (state2, action) => {
        ...
        switch (action.type) {
          ...
          case "gotoPage":
            ...
            break;
          case "update":
            if (action.iconName !== void 0) {
              newState.iconName = action.iconName;
            }
            if (action.keyword !== void 0) {
              newState.keyword = action.keyword;
              if (newState.keyword === "") {
                newState.activeIconNames = materiaIconNames_default;
              } else {
                newState.activeIconNames = materiaIconNames_default.filter((iconName) => iconName.includes(newState.keyword));
              }
            }
            break;
        }
      ...
      { page: 0, keyword: "", iconName: value, activeIconNames: materiaIconNames_default }
    );
    ...
    return /* @__PURE__ */ wp.element.createElement(Bem, null, /* @__PURE__ */ wp.element.createElement("div", { className: clsx(className, open ? "is-open" : "is-close"), ...otherProps }, /* @__PURE__ */ wp.element.createElement("span", { className: "_icon", style: { fontFamily: "Material Icons" }, onClick: () => setOpen(true) }, value), /* @__PURE__ */ wp.element.createElement(Catpow.Popover, { open, onClose: () => setOpen(false) }, /* @__PURE__ */ wp.element.createElement("div", { className: className + "__popover" }, /* @__PURE__ */ wp.element.createElement("div", { className: "_current" }, /* @__PURE__ */ wp.element.createElement("span", { className: "_icon", style: { fontFamily: "Material Icons" } }, value), /* @__PURE__ */ wp.element.createElement("div", { className: "_iconname" }, value)), /* @__PURE__ */ wp.element.createElement("div", { className: "_search" }, /* @__PURE__ */ wp.element.createElement("input", { type: "text", placeholder: "Search images...", value: state.keyword, onChange: (e) => dispatch({ type: "update", keyword: e.target.value }) })), /* @__PURE__ */ wp.element.createElement("div", { className: "_pages" }, [...chunk(state.activeIconNames, 100)].map((pageIconNames, index) => /* @__PURE__ */ wp.element.createElement("div", { className: clsx("_page", { "is-active": state.page === index }), key: index }, /* @__PURE__ */ wp.element.createElement("ul", { className: "items_" }, pageIconNames.map((iconName) => {
      return /* @__PURE__ */ wp.element.createElement("li", { className: clsx("_item", { "is-active": value == iconName }), key: iconName }, /* @__PURE__ */ wp.element.createElement("span", { className: "_icon", style: { fontFamily: "Material Icons" }, onClick: () => dispatch({ type: "update", iconName }) }, iconName));
    }))))), /* @__PURE__ */ wp.element.createElement("div", { className: "_pagenation" }, [...chunk(state.activeIconNames, 100)].map((_, index) => /* @__PURE__ */ wp.element.createElement("button", { key: index, className: clsx("_btn", { "is-active": state.page === index }), onClick: () => dispatch({ type: "gotoPage", page: index }) }, index + 1)))))));
  };
})();
