			...
			case "fixed":
				return (
					<svg id="a" data-name="image" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
						<rect x="2" y="8" width="16" height="11" />
						<path d="m16.75,8h-2c0-2.62-2.13-4.75-4.75-4.75s-4.75,2.13-4.75,4.75h-2c0-3.72,3.03-6.75,6.75-6.75s6.75,3.03,6.75,6.75Z" />
					</svg>
				);
			case "absolute":
				return (
					<svg id="a" data-name="image" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
						<path d="m1,2v17h18V2H1Zm1,1h6v7H2V3Zm16,15H2v-7h16v7Zm-1-5H3v-1h14v1Zm0,2H3v-1h14v1Zm0,2H3v-1h14v1Z" />
					</svg>
				);
			case "relative":
				return (
