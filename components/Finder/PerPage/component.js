...
Catpow.Finder.PerPage = function (props) {
	...
	var onChange = useCallback(function (e) {
		...
		dispatch({ type: 'setItemsPerPage', itemsPerPage: itemsPerPage });
	}, [dispatch]);
		...
		wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					"div",
					{ className: "inputs" },
					wp.element.createElement("input", { type: "number", value: state.itemsPerPage, min: "1", max: "1000", onChange: onChange }),
					__('件/頁', 'catpow')
				)
			)
		)
