      ...
      async (action) => {
        try {
          ...
          wp.apiFetch({
            ...
            if (res.message) {
              dispatch({ type: "showMessage", message: res.message });
            }
            if (res.download) {
        ...
        return new Promise((resolve, reject) => {
          ...
          setModal(
            /* @__PURE__ */ wp.element.createElement(
              ...
              })), /* @__PURE__ */ wp.element.createElement(Buttons, null, /* @__PURE__ */ wp.element.createElement(Button, { label: __("\u30AD\u30E3\u30F3\u30BB\u30EB", "catpow"), className: "negative", name: "accept", value: false }), /* @__PURE__ */ wp.element.createElement(Button, { label: __("\u5B9F\u884C", "catpow"), className: "primary", name: "accept", value: true })))
            )
          );
        });
      },
