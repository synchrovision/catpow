	...
	return wp.element.createElement(
		...
		wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement("div", { className: "icon dashicons dashicons-filter", onClick: function onClick() {
						return setOpen(!open);
					} }),
				wp.element.createElement(
					Catpow.Popover,
										...
										Object.keys(col.dict).map(function (val) {
											...
											return wp.element.createElement(Catpow.CheckBox, {
												...
												onChange: function onChange(selected) {
													return dispatch({ type: (selected ? 'add' : 'remove') + 'Query', key: key, val: val });
												}
											});
										})
									)
