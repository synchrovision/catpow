(() => {
  ...
  Catpow.Finder.Pagenate = (props) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "FinderPagenate" }, /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("div", { class: "icon dashicons dashicons-arrow-left-alt2" })
    ), /* @__PURE__ */ React.createElement("ul", { className: "items" }, [...Array(state.maxNumPages).keys()].map((i) => {
      const page = i + 1;
      ...
      /* @__PURE__ */ React.createElement("div", { class: "icon dashicons dashicons-arrow-right-alt2" })
    ));
  };
})();
