(() => {
  ...
  Catpow.AppManager = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement(Fragment, null, /* @__PURE__ */ wp.element.createElement(Catpow.AppManagerContext.Provider, { value: { state, dispatch } }, children), Object.keys(state.outerContents).map((name) => state.outerContents[name]));
  };
