Catpow.Calendar = function (props) {
	...
	var _props$className = props.className,
	    className = _props$className === undefined ? 'medium' : _props$className,
	    _props$min = props.min,
	    min = _props$min === undefined ? null : _props$min,
	    _props$max = props.max,
	    max = _props$max === undefined ? null : _props$max,
	    values = props.values,
	    onSelect = props.onSelect,
	    _props$showYear = props.showYear,
	    showYear = _props$showYear === undefined ? true : _props$showYear,
	    _props$showMonth = props.showMonth,
	    showMonth = _props$showMonth === undefined ? true : _props$showMonth,
	    _props$showControl = props.showControl,
	    showControl = _props$showControl === undefined ? false : _props$showControl;
		...
		wp.element.createElement(
			...
			wp.element.createElement(
				...
				showYear && wp.element.createElement(
					'div',
					{ className: 'year' },
					showControl && wp.element.createElement(
						Fragment,
						null,
						wp.element.createElement('span', { className: 'btn prev10', onClick: function onClick() {
								return dispatch({ type: 'prev10Year' });
							} }),
						wp.element.createElement('span', { className: 'btn prev', onClick: function onClick() {
								return dispatch({ type: 'prevYear' });
							} })
					),
					wp.element.createElement(
						'span',
					...
					showControl && wp.element.createElement(
						Fragment,
						null,
						wp.element.createElement('span', { className: 'btn next', onClick: function onClick() {
								return dispatch({ type: 'nextYear' });
							} }),
						wp.element.createElement('span', { className: 'btn next10', onClick: function onClick() {
								return dispatch({ type: 'next10Year' });
							} })
					)
				),
				showMonth && wp.element.createElement(
					'div',
					{ className: 'month' },
					showControl && wp.element.createElement('span', { className: 'btn prev', onClick: function onClick() {
							return dispatch({ type: 'prevMonth' });
						} }),
					wp.element.createElement(
						'span',
						{ 'class': 'current' },
					...
					showControl && wp.element.createElement('span', { className: 'btn next', onClick: function onClick() {
							return dispatch({ type: 'nextMonth' });
						} })
				)
			),
			thead,
							...
							return wp.element.createElement(
								'td',
								{
									...
									onClick: function onClick() {
										if (inRange) {
											onSelect(day.value, { day: day, value: value });
										}
									}
								},
								wp.element.createElement(
								...
								value && value.content && wp.element.createElement(
									'div',
									{ className: 'content' },
									value.content
								)
