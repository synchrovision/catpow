Catpow.Transition = function (props) {
	...
	var children = props.children,
	    ...
	    fitHeight = _props$fitHeight === undefined ? false : _props$fitHeight;
	...
	var getTransitionType = useCallback(function (prev, next) {
		...
		var _next$props = next.props,
		    ...
		    depth = _next$props$depth === undefined ? 1 : _next$props$depth,
		    _next$props$page = _next$props.page,
		    page = _next$props$page === undefined ? 1 : _next$props$page,
		    _next$props$view = _next$props.view,
		    view = _next$props$view === undefined ? 'normal' : _next$props$view;
		var _prev$props = prev.props,
		    _prev$props$depth = _prev$props.depth,
		    prevDeps = _prev$props$depth === undefined ? 1 : _prev$props$depth,
		    _prev$props$page = _prev$props.page,
		    prevPage = _prev$props$page === undefined ? 1 : _prev$props$page,
		    _prev$props$view = _prev$props.view,
		    prevView = _prev$props$view === undefined ? 'normal' : _prev$props$view;
	...
	return wp.element.createElement(
		'div',
		{ className: 'transition transition-' + type, ref: refContainer },
		wp.element.createElement('div', { className: "transition_prev transition_prev-" + (ready ? "from" : "to"), ref: refPrev }),
		wp.element.createElement(
			'div',
			{ className: "transition_current transition_current-" + (ready ? "from" : "to"), ref: refCurrent },
			contents
		)
	);
};
