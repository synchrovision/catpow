(() => {
  ...
  Catpow.StepSelect = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: classes() }, /* @__PURE__ */ wp.element.createElement("div", { className: classes.selected(), onClick: () => setOpen(true) }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.selected.items() }, state.selectedItems && state.selectedItems.length ? state.selectedItems.map((item) => /* @__PURE__ */ wp.element.createElement("li", { className: classes.selected.items.item(), onClick: () => toggleItem(item), key: item.value }, item.label, /* @__PURE__ */ wp.element.createElement("span", { className: classes.selected.items.item.button() }))) : /* @__PURE__ */ wp.element.createElement("li", { className: classes.selected.items.item() }, defaultLabel))), /* @__PURE__ */ wp.element.createElement(Catpow.Popup, { open, onClose: () => open && setOpen(false) }, /* @__PURE__ */ wp.element.createElement("div", { className: classes._body() }, /* @__PURE__ */ wp.element.createElement("div", { className: classes.selected(), onClick: () => setOpen(true) }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.selected.items() }, state.selectedItems && state.selectedItems.length ? state.selectedItems.map((item) => /* @__PURE__ */ wp.element.createElement("li", { className: classes.selected.items.item(), onClick: () => toggleItem(item), key: item.value }, item.label, /* @__PURE__ */ wp.element.createElement("span", { className: classes.selected.items.item.button() }))) : false)), /* @__PURE__ */ wp.element.createElement("div", { className: classes.selections() }, state.activeItems.map((activeItem, index) => /* @__PURE__ */ wp.element.createElement("div", { className: classes.selections.options(), key: index }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.selections.options.items() }, activeItem.options.map((item, index2) => /* @__PURE__ */ wp.element.createElement(
      "li",
      {
