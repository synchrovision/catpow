(() => {
  ...
  Catpow.SelectPreparedImage = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: classes("is-" + name, open ? "is-open" : "is-close"), ...otherProps }, /* @__PURE__ */ wp.element.createElement("img", { className: classes._img(), src: value, alt: "", width: "40", height: "40", onClick: () => setOpen(true) }), /* @__PURE__ */ wp.element.createElement(Catpow.Popover, { open, onClose: () => setOpen(false) }, /* @__PURE__ */ wp.element.createElement("ul", { className: classes.items() }, state.images.map((image) => {
      return /* @__PURE__ */ wp.element.createElement("li", { className: classes.items.item({ "is-active": value == image.url }), key: image.url }, /* @__PURE__ */ wp.element.createElement("img", { className: classes.items.item._img(), src: image.url, alt: image.alt, onClick: () => dispatch({ type: "update", image }) }));
    }))));
  };
})();
