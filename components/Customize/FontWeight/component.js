(() => {
  ...
  // ../components/Customize/FontWeight/component.jsx
  init_react();
  ...
  var DataSet = (props) => {
    const { labels: labels2, colors, classNames, translateToDisplayValue, values, steps: steps2 = { 100: 1 }, snap = true, onChange, children, ...otherProps } = props;
  ...
  Catpow.Customize.FontWeight = (props) => {
    ...
    return /* @__PURE__ */ wp.element.createElement(Bem, null, /* @__PURE__ */ wp.element.createElement(DataSet, { values, labels, steps, onChange: onChangeValues }, /* @__PURE__ */ wp.element.createElement(LineChartInput, { width: 400, height: 80 }), /* @__PURE__ */ wp.element.createElement(DataTable, null)));
  };
})();
