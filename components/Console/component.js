    ...
    const ControlItem = useCallback(
      (props2) => {
        ...
        const inputTypes = useMemo(
          () => ({
            text: (props3) => /* @__PURE__ */ wp.element.createElement(
              "input",
              {
                type: "text",
                onChange: (e) => {
            ...
            select: (props3) => /* @__PURE__ */ wp.element.createElement(
              SelectBox,
              {
                onChange: (value) => {
            ...
            checkbox: (props3) => /* @__PURE__ */ wp.element.createElement(
              CheckBoxes,
              {
                onChange: (value) => {
                  dispatch2({ type: "setData", name, value });
            ...
            radio: (props3) => /* @__PURE__ */ wp.element.createElement(
              RadioButtons,
              {
                onChange: (value) => {
                  dispatch2({ type: "setData", name, value });
            ...
            submit: (props3) => /* @__PURE__ */ wp.element.createElement(
              Buttons,
              {
                onClick: (action) => {
