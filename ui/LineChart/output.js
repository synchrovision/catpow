(() => {
  ...
  Catpow.UI.LineChartOutput = class extends wp.element.Component {
    ...
    render() {
      ...
      return /* @__PURE__ */ wp.element.createElement("div", { className: "cpui-linechart" }, /* @__PURE__ */ wp.element.createElement("svg", { viewBox: "0 0 300 300" }, pies));
    }
  };
})();
